...
## Overview
Core AI orchestration, API execution, and large language model configuration.

## Core Concepts
Context window management, prompt engineering, few-shot prompting, API rate limit management.
...
Master prompt sequencing, then explore tool calling and structured JSON output modes.
