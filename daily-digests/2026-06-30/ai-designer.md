...
discovered_at: "2026-06-30T10:54:55Z"
...
## Key Features
- Real-time live page editing via AI agent in a Chrome side panel
- Ephemeral DOM/CSS mutations that reset on page reload
- Structured changeset generation for review and handoff
- Seamless MCP integration to ship changes as PRs to a dev backend
- BYOK (Bring Your Own Key) for OpenRouter and MCP tokens

## Why It Matters for RAG Builders
It bridges the gap between visual design and code by enabling AI-driven live edits that can be shipped as real PRs, reducing the manual effort in translating design changes into code.
