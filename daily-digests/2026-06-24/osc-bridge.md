...
tech_stack: ["Rust", "TypeScript", "Lua 5.4", "MIDI", "SysEx", "OSC (Open Sound Control)", "JSON", "MCP (Model Context Protocol)", "Node.js", "Electra One MK2", "CI/CD (GitHub Actions)"]
quality_score: 9
rag_relevance: 9
tags: ["MIDI/OSC bridge", "LLM integration", "MCP server", "music hardware control", "declarative device mapping"]
