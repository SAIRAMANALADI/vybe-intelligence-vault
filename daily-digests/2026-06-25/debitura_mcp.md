...
tech_stack: ["TypeScript", "Node.js", "Model Context Protocol (MCP)", "HTTP/Streamable", "OpenAPI", "Docker", "Cloudflare (for rate limiting)"]
quality_score: 9
rag_relevance: 7
tags: ["MCP server", "debt collection", "cross-border", "AI integration", "financial API"]
