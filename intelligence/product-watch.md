...
New AI templates, platforms, context servers, and interface boilerplates for developers.
...
| [ANSI escape injection in MCP servers: Hidden from humans, visible to AI](https://brightsec.com/research/detecting-ansi-escape-sequence-injection-in-mcp-servers-with-dast) | `mcp-registry/` | 70 |
