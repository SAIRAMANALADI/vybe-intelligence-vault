...
## Summary
A real-time AI companion runtime designed for eldercare scenarios, featuring WebSocket-based streaming conversations, risk detection (health emergencies, scams, emotional distress), tool calling, long-term memory, model hot-swapping, and full-chain trace observability.

## Key Features
- WebSocket-based real-time streaming conversations with traceability
- Multi-level risk detection (health emergencies, scams, emotional distress) with immediate interception
- Dynamic model routing with hot-swapping (primary/fallback/fast roles)
- Long-term memory system with Redis, PostgreSQL, and pgvector integration
- Full-chain trace observability with OpenTelemetry, Jaeger, and Prometheus

## Why It Matters for RAG Builders
This runtime provides a production-ready foundation for building eldercare-focused AI companions with robust risk mitigation, memory persistence, and observability, reducing development time for RAG/AI stack builders.
