...
Active signals: 4098 resources matched in the intelligence vault.
...
- [Privacy Leakage in Federated Learning: Gradient-Based Client Identity Inference and Defenses for Inertial Sensing in Vehicular Edge Networks](../ai/research/arxiv-2609-02971.md) (Source: Unknown Source) - Collected 2026-09-10
...
### 4. [airalab/autonomous_agent_template](../ai/rag/airalab-autonomous-agent-template.md) ([GitHub](https://github.com/airalab/autonomous_agent_template))
- Stars: 0
- Language: Unknown
...
### 19. [mongodb-developer/GenAI-Showcase](../ai/rag/mongodb-developer-genai-showcase.md) ([GitHub](https://github.com/mongodb-developer/genai-showcase))
- Stars: 0
- Language: Unknown
...
### 23. [vercel-labs/coding-agent-template](../ai/rag/vercel-labs-coding-agent-template.md) ([GitHub](https://github.com/vercel-labs/coding-agent-template))
- Stars: 0
- Language: Unknown
...
### 24. [deepset-ai/haystack](../ai/rag/deepset-ai-haystack.md) ([GitHub](https://github.com/deepset-ai/haystack))
- Stars: 0
- Language: Unknown
...
### 32. [bojieli/ai-agent-book](../ai/rag/bojieli-ai-agent-book.md) ([GitHub](https://github.com/bojieli/ai-agent-book))
- Stars: 0
- Language: Unknown
- Description: - **Repository Contents**: Open-source repository for the book " AI Agent" by Bojieli, including full text, compiled PDFs, and chapter-specific code implementations.

### 33. [GitHub recognized as a Leader by 2026 Gartner® Magic Quadrant™ for Enterprise AI Coding Agents · GitHub](../ai/rag/resources-whitepapers.md) ([GitHub](https://github.com/resources/whitepapers))
- Stars: 0
- Language: Unknown
...
### 34. [NirDiamant/RAG_Techniques](../ai/rag/nirdiamant-rag-techniques.md) ([GitHub](https://github.com/nirdiamant/rag_techniques))
- Stars: 0
- Language: Unknown
...
### 39. [vndee/local-assistant-examples](../ai/rag/vndee-local-assistant-examples.md) ([GitHub](https://github.com/vndee/local-assistant-examples))
- Stars: 0
- Language: Unknown
...
### 47. [run-llama/ParseBench](../ai/rag/run-llama-parsebench.md) ([GitHub](https://github.com/run-llama/parsebench))
- Stars: 0
- Language: Unknown
- Description: - **Purpose**: ParseBench is a document parsing benchmark designed to evaluate AI agents' performance in parsing diverse document types (e.g., PDFs, tables, OCR-extracted text) using metrics tailor...

### 48. [truefoundry/cognita](../ai/rag/truefoundry-cognita.md) ([GitHub](https://github.com/truefoundry/cognita))
- Stars: 0
- Language: Unknown
...
### 50. [VoltAgent/awesome-ai-agent-papers](../ai/rag/voltagent-awesome-ai-agent-papers.md) ([GitHub](https://github.com/voltagent/awesome-ai-agent-papers))
- Stars: 0
- Language: Unknown
- Description: - **Curated 2026 AI Agent Research**: Repository aggregates cutting-edge papers on AI agents, emphasizing agent engineering, memory systems, evaluation frameworks, workflows, and autonomous archite...
