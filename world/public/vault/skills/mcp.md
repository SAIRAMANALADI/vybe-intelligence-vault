...
### 29. [google-gemini/gemini-cli](../ai/rag/google-gemini-gemini-cli.md) ([GitHub](https://github.com/google-gemini/gemini-cli))
- Stars: 0
- Language: Unknown
...
### 40. [pinecone-io/pinecone-claude-code-plugin](../ai/rag/pinecone-io-pinecone-claude-code-plugin.md) ([GitHub](https://github.com/pinecone-io/pinecone-claude-code-plugin))
- Stars: 0
- Language: Unknown
