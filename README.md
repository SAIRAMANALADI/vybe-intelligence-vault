...
The result: a self-reinforcing knowledge graph of **56,360 indexed resources** spanning AI agents, RAG architectures, MCP servers, and modern web tooling — always current, always queryable by local agents via an HTTP gateway.
  ...
  <table>
    <tr>
      <td align="center">
        ...
        <p><b>Resources tracked:</b> 13,081</p>
        <p><b>Active:</b> 12,776 | <b>Inactive:</b> 305</p>
      </td>
      <td align="center">
        <h3>📂 Archives & Maps</h3>
