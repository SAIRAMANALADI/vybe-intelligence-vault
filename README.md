...
[![Resources](https://img.shields.io/badge/Resources%20Indexed-122%2C837-1f2937?style=flat-square)](#)
...
The result: a self-reinforcing knowledge graph of **122,837 indexed resources** spanning AI agents, RAG architectures, MCP servers, and modern web tooling — always current, always queryable by local agents via an HTTP gateway.
  ...
  <table>
    <tr>
      <td align="center">
        ...
        <p><b>Resources tracked:</b> 19,136</p>
        <p><b>Active:</b> 18,545 | <b>Inactive:</b> 591</p>
      </td>
      <td align="center">
        <h3>📂 Archives & Maps</h3>
      ...
      <td align="center">
        <h3>⚡ Status</h3>
        <p><b>Total Vault Size:</b> 122,837 files</p>
        <p><b>Last Update:</b> 2026-08-14 05:21 IST</p>
...
- 🔼 **[ParticleMedia/RAGTruth](ai/rag/particlemedia-ragtruth.md)** • Rank: <kbd>+977</kbd>
- 🔼 **[datawhalechina/llm-universe](ai/rag/datawhalechina-llm-universe.md)** • Rank: <kbd>+977</kbd>
- 🔼 **[Retrieval-Augmented Generation (RAG) Chatbots for Education: A Survey of Applications](ai/research/retrieval-augmented-generation-rag-chatbots-for-ed.md)** • Rank: <kbd>+977</kbd>
