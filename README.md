  ...
  <table>
    <tr>
      <td align="center">
        ...
        <p><b>Active:</b> 20,626 | <b>Inactive:</b> 664</p>
      </td>
      <td align="center">
        <h3>📂 Archives & Maps</h3>
      ...
      <td align="center">
        ...
        <p><b>Last Update:</b> 2026-08-19 15:15 IST</p>
...
- 🔼 **[The-Pocket/PocketFlow-Template-Python](ai/agents/the-pocket-pocketflow-template-python.md)** • Rank: <kbd>+981</kbd>
- 🔼 **[Spectrally Safe Neural Operator Warm-Starts for Large-Scale Newton Solvers](ai/rag/arxiv-2606-21828.md)** • Rank: <kbd>+981</kbd>
- 🔼 **[SEAM: Shortcut-Aware Real-Time Detection of Scripted vs. Spontaneous Speech for Interview Guardrails](ai/research/arxiv-2606-06837.md)** • Rank: <kbd>+981</kbd>
- 🔼 **[Memory by Design: Probabilistic Sequence Layers](ai/research/arxiv-2605-31163.md)** • Rank: <kbd>+981</kbd>
- 🔼 **[Nonlinear GENERIC-Embedded Neural Networks (N-GENNs): Learning GENERIC dynamics with non-quadratic dissipation potentials](ai/research/arxiv-2605-09058.md)** • Rank: <kbd>+981</kbd>
