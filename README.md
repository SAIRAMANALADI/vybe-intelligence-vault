...
| Metric | Count |
|---|---:|
| Resources tracked | 3807 |
| Active resources | 3759 |
...
| Build ideas | 8 |
| Best-of guides | 6 |
| Last meaningful update | 2026-06-16 19:39 IST |

### Trend Intelligence Dashboard

#### 🔥 Trending Resources
- **[Feds freaked over Fable 5 after simple 'fix this code' prompt, not jailbreak](ai/community/feds-freaked-over-fable-5-after-simple-fix-this-co.md)** (Rank: +1) (+171 points)
- **[Ask HN: Has anyone replaced Claude/GPT with a local model for daily coding?](ai/community/ask-hn-has-anyone-replaced-claude-gpt-with-a-local.md)** (+67 points)
- **[TinyWind: A pixel pirate sailing game with real wind physics (380k+ kms sailed)](ai/community/tinywind-a-pixel-pirate-sailing-game-with-real-win.md)** (+38 points)
...
#### ✨ New Discoveries
- **[parallel75/Microsoft_AutoGen_Tutorial](ai/agents/parallel75-microsoft-autogen-tutorial.md)** (Score: 0)
- **[tylerprogramming/ai](ai/agents/tylerprogramming-ai.md)** (Score: 0)
- **[Sameera-Nazneen/AutogeneratedCV.github.io](ai/agents/sameera-nazneen-autogeneratedcv-github-io.md)** (Score: 0)
- **[abuzarmahmood/blech_github_bot](ai/agents/abuzarmahmood-blech-github-bot.md)** (Score: 0)
- **[CS-433/ml-project-2-nlp_of_autogentext](ai/agents/cs-433-ml-project-2-nlp-of-autogentext.md)** (Score: 0)
