  ...
  <table>
    <tr>
      <td align="center">
        ...
        <p><b>Active:</b> 20,627 | <b>Inactive:</b> 663</p>
      </td>
      <td align="center">
        <h3>📂 Archives & Maps</h3>
      ...
      <td align="center">
        ...
        <p><b>Last Update:</b> 2026-08-19 12:24 IST</p>
...
- 🔼 **[Spectrally Safe Neural Operator Warm-Starts for Large-Scale Newton Solvers](ai/rag/arxiv-2606-21828.md)** • Rank: <kbd>+125</kbd>
- 🔼 **[SEAM: Shortcut-Aware Real-Time Detection of Scripted vs. Spontaneous Speech for Interview Guardrails](ai/research/arxiv-2606-06837.md)** • Rank: <kbd>+125</kbd>
- 🔼 **[Memory by Design: Probabilistic Sequence Layers](ai/research/arxiv-2605-31163.md)** • Rank: <kbd>+125</kbd>
- 🔼 **[Nonlinear GENERIC-Embedded Neural Networks (N-GENNs): Learning GENERIC dynamics with non-quadratic dissipation potentials](ai/research/arxiv-2605-09058.md)** • Rank: <kbd>+125</kbd>
- 🔼 **[From Diffusion to Flow: Efficient Motion Generation in MotionGPT3](ai/research/arxiv-2603-26747.md)** • Rank: <kbd>+125</kbd>
