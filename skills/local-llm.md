...
Active signals: 242 resources matched in the intelligence vault.
...
- [Ollama](../ai/rag/ollama.md) (Source: Unknown Source) - Collected 2026-07-20
...
- Stars: 0
- Language: Unknown
- Description: - **Multi-model support**: Ollama provides CLI tools to locally run a variety of LLMs including Kimi-K2.6, GLM-5.2, MiniMax, DeepSeek, gpt-oss, Qwen, Gemma, and Llama variants (e.g., Llama3, Gemma3...
...
- Stars: 0
- Language: Unknown
- Description: - **Implementation**: Demonstrates building a local ChatPDF system using Python, leveraging LangChain for LLM integration, Ollama for local LLM deployment, and RAG (Retrieval-Augmented Generation) ...

### 3. [prometheus-eval/BiGGen-Bench at main · prometheus-eval/prometheus-eval · GitHub](../ai/rag/prometheus-eval-prometheus-eval.md) ([GitHub](https://github.com/prometheus-eval/prometheus-eval))
- Stars: 0
- Language: Unknown
...
### 9. [rosgluk (Rost Glukhov) · GitHub](../ai/agents/rosgluk-rost-glukhov-github.md) ([GitHub](https://github.com/rosgluk))
- Stars: 0
- Language: Unknown
...
### 11. [curiousily/AI-Bootcamp](../ai/rag/curiousily-ai-bootcamp.md) ([GitHub](https://github.com/curiousily/ai-bootcamp))
- Stars: 0
- Language: Unknown
...
- Stars: 0
- Language: Unknown
- Description: - **Learning Path**: A structured 5-week curriculum covering RAG fundamentals, hybrid search (vector + keyword), quantization (binary/scalar), and advanced techniques like HNSW indexing and Matryos...

### 13. [pathwaycom/llm-app](../ai/rag/pathwaycom-llm-app.md) ([GitHub](https://github.com/pathwaycom/llm-app))
- Stars: 0
- Language: Unknown
- Description: - **Cloud-native RAG & AI pipeline templates** with Docker support, enabling real-time enterprise search and AI workflows (SharePoint, Google Drive, S3, Kafka, PostgreSQL, APIs).

### 14. [mit-han-lab/smoothquant](../ai/rag/mit-han-lab-smoothquant.md) ([GitHub](https://github.com/mit-han-lab/smoothquant))
- Stars: 0
- Language: Unknown
...
- Stars: 0
- Language: Unknown
- Description: - **TypeScript-based open-source coding agent**: Continue is an autonomous AI coding assistant built in TypeScript, enabling local or remote LLM integration for code generation, debugging, and refa...
...
### 18. [earendil-works/pi](../ai/agents/earendil-works-pi.md) ([GitHub](https://github.com/earendil-works/pi))
- Stars: 0
- Language: Unknown
- Description: - **Unified LLM API Abstraction**: Provides a standardized interface to interact with multiple large language models (LLMs) via a single API, abstracting provider-specific complexities (e.g., OpenA...
