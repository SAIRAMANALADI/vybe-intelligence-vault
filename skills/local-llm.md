...
- [NanGePlus/CrewAITest](../ai/agents/nangeplus-crewaitest.md) (Source: Unknown Source) - Collected 2026-08-01
- [AgentOps-AI/agentops](../ai/agents/agentops-ai-agentops.md) (Source: Unknown Source) - Collected 2026-08-01
- [pguso/ai-agents-from-scratch](../ai/agents/pguso-ai-agents-from-scratch.md) (Source: Unknown Source) - Collected 2026-08-01
- [vndee/local-assistant-examples](../ai/rag/vndee-local-assistant-examples.md) (Source: Unknown Source) - Collected 2026-08-01
- [Tencent/WeKnora](../ai/rag/tencent-weknora.md) (Source: Unknown Source) - Collected 2026-08-01
...
- Stars: 0
- Language: Unknown
- Description: - **Implementation**: Provides a Python-based framework for deploying a local ChatPDF system using LangChain, leveraging RAG (Retrieval-Augmented Generation) for document processing and Ollama for ...
...
- Stars: 0
- Language: Unknown
- Description: - **Educational RAG Pipeline**: Demonstrates Retrieval-Augmented Generation (RAG) implementation from scratch using local LLMs (via `node-llama-cpp`) to avoid black-box abstractions, focusing on em...
...
- Stars: 0
- Language: Unknown
- Description: - **Multi-functional LLM Platform**: Converts raw documents into a queryable Retrieval-Augmented Generation (RAG) system, an autonomous reasoning agent, and a self-maintaining Wiki, supporting both...
...
- Stars: 0
- Language: Unknown
- Description: - **Python SDK** for monitoring AI agents, tracking LLM costs, and benchmarking, with integrations across major LLM providers (OpenAI, Anthropic, Mistral, Groq) and agent frameworks (CrewAI, LangCh...
