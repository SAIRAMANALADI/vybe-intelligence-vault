...
Active signals: 372 resources matched in the intelligence vault.
Recently detected signals:
- [Installation - vLLM](../ai/resources/installation-vllm.md) (Source: Unknown Source) - Collected 2026-08-05
...
- [vndee/local-assistant-examples](../ai/rag/vndee-local-assistant-examples.md) (Source: Unknown Source) - Collected 2026-08-05
- [Tencent/WeKnora](../ai/rag/tencent-weknora.md) (Source: Unknown Source) - Collected 2026-08-05
...
- Stars: 0
- Language: Unknown
- Description: - **Purpose**: Demonstrates building a local ChatPDF application using LangChain, LLMs, and Ollama with RAG (Retrieval-Augmented Generation) for document interaction.
...
- Stars: 0
- Language: Unknown
- Description: - **Multi-Model RAG & Agent Framework**: WeKnora transforms raw documents into a queryable Retrieval-Augmented Generation (RAG) system, supports autonomous reasoning agents, and maintains a self-up...
...
- Stars: 0
- Language: Unknown
- Description: - **Educational Repository**: Provides a hands-on tutorial for building AI agents from scratch using JavaScript, emphasizing local LLMs (via `node-llama-cpp`) to avoid black-box dependencies.
