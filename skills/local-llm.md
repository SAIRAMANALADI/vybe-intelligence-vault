...
- [Gemma â Google DeepMind](../ai/rag/gemma-a-google-deepmind.md) (Source: Unknown Source) - Collected 2026-08-10
...
- Stars: 0
- Language: Unknown
- Description: - **Purpose**: Demonstrates building a local ChatPDF application using LangChain, LLMs, and Ollama with Retrieval-Augmented Generation (RAG) for document interaction.
...
- Stars: 0
- Language: Unknown
- Description: - **Educational RAG Pipeline**: Provides a step-by-step implementation of Retrieval-Augmented Generation (RAG) from scratch using JavaScript, focusing on local LLMs (via `node-llama-cpp`) to elimin...
...
- Stars: 0
- Language: Unknown
- Description: *   Python SDK providing AI agent monitoring, LLM cost tracking, and performance benchmarking/evaluation capabilities.
