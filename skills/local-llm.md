...
- Stars: 0
- Language: Unknown
- Description: - **Multi-modal RAG & Agentic Framework**: WeKnora transforms raw documents into a queryable Retrieval-Augmented Generation (RAG) system, supports autonomous reasoning agents, and maintains a self-...
...
- Stars: 0
- Language: Unknown
- Description: - **LangChain-based RAG pipeline**: Implements a Retrieval-Augmented Generation (RAG) system using LangChain to process and query local PDF documents via vector embeddings and LLM integration.

### 8. [pguso/rag-from-scratch](../ai/rag/pguso-rag-from-scratch.md) ([GitHub](https://github.com/pguso/rag-from-scratch))
- Stars: 0
- Language: Unknown
- Description: - **Implementation**: Demonstrates Retrieval-Augmented Generation (RAG) pipeline using local LLMs with Node.js (`node-llama-cpp`), emphasizing transparency by avoiding proprietary APIs or black-box...
...
- Stars: 0
- Language: Unknown
- Description: - **Local LLM Integration**: Demonstrates how to deploy and utilize local language models (LLMs) within a Retrieval-Augmented Generation (RAG) pipeline using LangChain, avoiding cloud-based LLM dep...
