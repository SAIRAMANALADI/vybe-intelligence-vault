...
- [Cohere Rerank: Say Goodbye to Irrelevant Search Results](../ai/rag/cohere-rerank-say-goodbye-to-irrelevant-search-res.md) (Source: Unknown Source) - Collected 2026-08-04
- [NanGePlus/CrewAITest](../ai/agents/nangeplus-crewaitest.md) (Source: Unknown Source) - Collected 2026-08-04
...
- [ray-project/llm-applications](../ai/rag/ray-project-llm-applications.md) (Source: Unknown Source) - Collected 2026-08-04
...
- Stars: 0
- Language: Unknown
- Description: - **Multi-modal LLM Knowledge Platform**: Converts raw documents into a queryable Retrieval-Augmented Generation (RAG) system, autonomous reasoning agent, and self-maintaining Wiki, supporting mult...
...
- Stars: 0
- Language: Unknown
- Description: - **Local LLM Integration**: Demonstrates implementation of Retrieval-Augmented Generation (RAG) using local language models (LLMs) via LangChain, avoiding cloud dependency.
...
- Stars: 0
- Language: Unknown
- Description: - **RAG Time**: A structured 5-week curriculum for mastering Retrieval-Augmented Generation (RAG) systems, covering hybrid search, quantization (binary/scalar), and indexing techniques (HNSW) with ...

### 16. [Cinnamon/kotaemon](../ai/rag/cinnamon-kotaemon.md) ([GitHub](https://github.com/cinnamon/kotaemon))
- Stars: 0
- Language: Unknown
- Description: - **RAG-based Architecture**: Implements Retrieval-Augmented Generation (RAG) to enable contextual document interaction by combining document retrieval with large language models (LLMs) for enhance...
...
- Stars: 0
- Language: Unknown
- Description: - **Multi-Agent Framework**: Implements a **CrewAI**-based system with **FastAPI** to deploy collaborative AI agents, enabling parallel task execution and inter-agent communication via RESTful API ...
...
### 21. [continuedev/continue](../ai/agents/continuedev-continue.md) ([GitHub](https://github.com/continuedev/continue))
- Stars: 0
- Language: Unknown
