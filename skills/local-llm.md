...
- [Losses — Sentence Transformers documentation](../ai/rag/losses-sentence-transformers-documentation.md) (Source: Unknown Source) - Collected 2026-08-05
...
- [AgentOps-AI/agentops](../ai/agents/agentops-ai-agentops.md) (Source: Unknown Source) - Collected 2026-08-05
...
- Stars: 0
- Language: Unknown
- Description: - **Multi-Model Support**: Enables local execution of advanced LLMs (e.g., Kimi-K2.6, GLM-5.2, DeepSeek, Qwen, Gemma3) via a Go-based framework optimized for performance and ease of deployment.
...
- Stars: 0
- Language: Unknown
- Description: - **Purpose**: Demonstrates building a local ChatPDF application using Python, leveraging LangChain, LLMs, and Ollama for RAG (Retrieval-Augmented Generation).

### 5. [prometheus-eval/BiGGen-Bench at main · prometheus-eval/prometheus-eval · GitHub](../ai/rag/prometheus-eval-prometheus-eval.md) ([GitHub](https://github.com/prometheus-eval/prometheus-eval))
- Stars: 0
- Language: Unknown
...
- Stars: 0
- Language: Unknown
- Description: - **Educational RAG Implementation**: Demonstrates Retrieval-Augmented Generation (RAG) from scratch using Node.js and `node-llama-cpp`, emphasizing transparency by avoiding proprietary black boxes.

### 7. [llmware-ai/llmware](../ai/rag/llmware-ai-llmware.md) ([GitHub](https://github.com/llmware-ai/llmware))
- Stars: 0
- Language: Unknown
...
- Stars: 0
- Language: Unknown
- Description: - **5-week structured curriculum** covering **Retrieval-Augmented Generation (RAG)** fundamentals, hybrid search (vector + keyword), and advanced techniques like **binary/scalar quantization** and ...

### 12. [AgentOps-AI/agentops](../ai/agents/agentops-ai-agentops.md) ([GitHub](https://github.com/agentops-ai/agentops))
- Stars: 0
- Language: Unknown
- Description: - **Python SDK** for monitoring AI agents, tracking LLM costs, and benchmarking, compatible with frameworks like CrewAI, LangChain, Autogen, and OpenAI Agents SDK.
...
### 14. [ragas/docs/getstarted/evals.md at main · vibrantlabsai/ragas · GitHub](../ai/rag/vibrantlabsai-ragas.md) ([GitHub](https://github.com/vibrantlabsai/ragas))
- Stars: 0
- Language: Unknown
...
### 17. [IntelLabs/fastRAG](../ai/rag/intellabs-fastrag.md) ([GitHub](https://github.com/intellabs/fastrag))
- Stars: 0
- Language: Unknown
- Description: - **Framework Overview**: FastRAG is an efficient, modular Python framework for Retrieval-Augmented Generation (RAG) optimized for low-latency, high-throughput applications, leveraging Intel hardwa...
...
### 20. [docker/compose-for-agents](../ai/agents/docker-compose-for-agents.md) ([GitHub](https://github.com/docker/compose-for-agents))
- Stars: 0
- Language: Unknown
- Description: *   Orchestrates AI agent workflows using Docker Compose, integrating open-source LLMs (e.g., Llama.cpp) and various agent runtimes/tools.

### 21. [pguso/ai-agents-from-scratch](../ai/agents/pguso-ai-agents-from-scratch.md) ([GitHub](https://github.com/pguso/ai-agents-from-scratch))
- Stars: 0
- Language: Unknown
- Description: - **Educational Repository**: Provides a hands-on tutorial for building AI agents from scratch using local LLMs (via `node-llama-cpp`), emphasizing transparency by avoiding black-box abstractions.
...
### 23. [Bhaskar-Kurasala/AI-Arch-Hub](../ai/rag/bhaskar-kurasala-ai-arch-hub.md) ([GitHub](https://github.com/bhaskar-kurasala/ai-arch-hub))
- Stars: 0
- Language: Unknown
