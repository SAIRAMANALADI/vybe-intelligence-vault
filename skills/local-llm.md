...
Active signals: 330 resources matched in the intelligence vault.
Recently detected signals:
- [Ollama](../ai/rag/ollama.md) (Source: Unknown Source) - Collected 2026-08-01
- [Vespa Demos](../ai/rag/vespa-demos.md) (Source: Unknown Source) - Collected 2026-08-01
- [llmware-ai/llmware](../ai/rag/llmware-ai-llmware.md) (Source: Unknown Source) - Collected 2026-08-01
- [NVIDIA Nemotron V2 - a nvidia Collection](../ai/resources/huggingface-collections-nvidia.md) (Source: Unknown Source) - Collected 2026-08-01
- [AgentOps-AI/agentops](../ai/agents/agentops-ai-agentops.md) (Source: Unknown Source) - Collected 2026-08-01
...
- Stars: 0
- Language: Unknown
- Description: - **Local ChatPDF Implementation**: Demonstrates building a local ChatPDF system using Python, leveraging LangChain for LLM integration and Ollama for model inference.
...
- Stars: 0
- Language: Unknown
- Description: - **Multi-Functional LLM Platform**: WeKnora transforms raw documents into a **queryable RAG system**, an **autonomous reasoning agent**, and a **self-maintaining Wiki**, supporting **multi-tenancy...
...
- Stars: 0
- Language: Unknown
- Description: - **Local LLM Integration**: Demonstrates RAG workflows using locally hosted large language models (LLMs) for privacy and offline capability, leveraging frameworks like LangChain for orchestration.
...
- Stars: 0
- Language: Unknown
- Description: - **Educational Repository**: Provides a hands-on tutorial for building AI agents from scratch using local LLMs, emphasizing transparency in function calling, memory management, and ReAct (Reasonin...
...
- Stars: 0
- Language: Unknown
- Description: *   Orchestrates AI agent stacks using Docker Compose for declarative deployment.
