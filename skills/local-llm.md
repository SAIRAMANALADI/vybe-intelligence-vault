...
- [docker/compose-for-agents](../ai/agents/docker-compose-for-agents.md) (Source: Unknown Source) - Collected 2026-09-02
- [pguso/ai-agents-from-scratch](../ai/agents/pguso-ai-agents-from-scratch.md) (Source: Unknown Source) - Collected 2026-09-02
...
- Stars: 0
- Language: Unknown
- Description: - **Implementation Guide**: Provides a Python-based framework using LangChain and Ollama to build a locally deployable ChatPDF application with Retrieval-Augmented Generation (RAG) capabilities.

### 4. [Tencent/WeKnora](../ai/rag/tencent-weknora.md) ([GitHub](https://github.com/tencent/weknora))
- Stars: 0
- Language: Unknown
- Description: - **Multi-modal Knowledge Platform**: WeKnora transforms raw documents into a **queryable RAG (Retrieval-Augmented Generation) system**, an **autonomous reasoning agent**, and a **self-maintaining ...
...
### 8. [prometheus-eval/BiGGen-Bench at main · prometheus-eval/prometheus-eval · GitHub](../ai/rag/prometheus-eval-prometheus-eval.md) ([GitHub](https://github.com/prometheus-eval/prometheus-eval))
- Stars: 0
- Language: Unknown
...
### 10. [ollama/ollama-python](../ai/resources/ollama-ollama-python.md) ([GitHub](https://github.com/ollama/ollama-python))
- Stars: 0
- Language: Unknown
...
### 15. [docker/compose-for-agents](../ai/agents/docker-compose-for-agents.md) ([GitHub](https://github.com/docker/compose-for-agents))
- Stars: 0
- Language: Unknown
...
- Stars: 0
- Language: Unknown
- Description: - **Multi-Agent System**: Implements a collaborative multi-agent architecture using CrewAI for task orchestration and FastAPI for RESTful API service provision.
...
### 21. [microsoft/tutel](../ai/resources/microsoft-tutel.md) ([GitHub](https://github.com/microsoft/tutel))
- Stars: 0
- Language: Unknown
...
### 22. [llamasearchai/OpenAGI-Customization](../ai/resources/llamasearchai-openagi-customization.md) ([GitHub](https://github.com/llamasearchai/openagi-customization))
- Stars: 0
- Language: Unknown
