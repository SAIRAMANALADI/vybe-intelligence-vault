...
Active signals: 345 resources matched in the intelligence vault.
...
- [bangoc123/retrieval-backend-with-rag](../ai/rag/bangoc123-retrieval-backend-with-rag.md) (Source: Unknown Source) - Collected 2026-08-03
...
- Stars: 0
- Language: Unknown
- Description: - **Multi-Model RAG & Agent Framework**: Implements a Go-based platform for converting raw documents into a queryable Retrieval-Augmented Generation (RAG) system, an autonomous reasoning agent, and...
...
- Stars: 0
- Language: Unknown
- Description: *   Implements a local Retrieval-Augmented Generation (RAG) system for document-based Q&A (ChatPDF).
...
- Stars: 0
- Language: Unknown
- Description: - **Educational RAG Implementation**: Provides a step-by-step guide to building Retrieval-Augmented Generation (RAG) systems from scratch using JavaScript, emphasizing transparency and understandin...
...
- Stars: 0
- Language: Unknown
- Description: - **Vietnamese RAG Implementation**: Repository demonstrates Retrieval-Augmented Generation (RAG) best practices tailored for Vietnamese language processing, including text preprocessing, embedding...

### 12. [pixegami/rag-tutorial-v2](../ai/rag/pixegami-rag-tutorial-v2.md) ([GitHub](https://github.com/pixegami/rag-tutorial-v2))
- Stars: 0
- Language: Unknown
- Description: - **Local LLM Integration**: Demonstrates a RAG pipeline leveraging local language models (e.g., Ollama) for offline inference, reducing dependency on cloud-based APIs.
...
- Stars: 0
- Language: Unknown
- Description: - **RAG Time** is a structured 5-week learning program focused on mastering **Retrieval-Augmented Generation (RAG)**, covering topics like **vector search**, **hybrid search**, **quantization (bina...
