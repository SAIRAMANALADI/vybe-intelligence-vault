...
Active signals: 347 resources matched in the intelligence vault.
Recently detected signals:
- [huggingface/text-embeddings-inference](../ai/rag/huggingface-text-embeddings-inference.md) (Source: Unknown Source) - Collected 2026-08-03
- [Cross-Encoders — Sentence Transformers documentation](../ai/rag/cross-encoders-sentence-transformers-documentation.md) (Source: Unknown Source) - Collected 2026-08-03
...
- [AgentOps-AI/agentops](../ai/agents/agentops-ai-agentops.md) (Source: Unknown Source) - Collected 2026-08-03
- [pguso/ai-agents-from-scratch](../ai/agents/pguso-ai-agents-from-scratch.md) (Source: Unknown Source) - Collected 2026-08-03
...
- Stars: 0
- Language: Unknown
- Description: - **Educational RAG Implementation**: Demonstrates Retrieval-Augmented Generation (RAG) from scratch using JavaScript, focusing on local LLMs (via `node-llama-cpp`) to avoid black-box dependencies.

### 9. [Tencent/WeKnora](../ai/rag/tencent-weknora.md) ([GitHub](https://github.com/tencent/weknora))
- Stars: 0
- Language: Unknown
- Description: - **Multi-functional LLM Platform**: Converts raw documents into a queryable RAG system, autonomous reasoning agent, and self-maintaining Wiki with support for multi-tenancy and multimodal models.

### 10. [pixegami/rag-tutorial-v2](../ai/rag/pixegami-rag-tutorial-v2.md) ([GitHub](https://github.com/pixegami/rag-tutorial-v2))
- Stars: 0
- Language: Unknown
- Description: - **Local LLM Integration**: Demonstrates RAG pipeline implementation using local language models (e.g., Ollama) with Langchain, avoiding cloud dependency.
...
- Stars: 0
- Language: Unknown
- Description: - **Multi-Framework Integration**: Python SDK supporting monitoring, cost tracking, and benchmarking for AI agents across frameworks like CrewAI, LangChain, Autogen, OpenAI Agents SDK, Agno, AG2, a...
...
- Stars: 0
- Language: Unknown
- Description: - **5-week structured RAG mastery program** using Jupyter Notebooks, covering hybrid search (vector + keyword), quantization (binary/scalar), and HNSW indexing for efficient retrieval.

### 16. [pathwaycom/llm-app](../ai/rag/pathwaycom-llm-app.md) ([GitHub](https://github.com/pathwaycom/llm-app))
- Stars: 0
- Language: Unknown
- Description: - **Cloud-native RAG & AI pipelines**: Docker-optimized templates for Retrieval-Augmented Generation (RAG), AI workflows, and enterprise search with live data synchronization across SharePoint, Goo...
