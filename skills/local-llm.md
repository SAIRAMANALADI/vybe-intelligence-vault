...
- [vndee/local-assistant-examples](../ai/rag/vndee-local-assistant-examples.md) (Source: Unknown Source) - Collected 2026-08-09
...
- Stars: 0
- Language: Unknown
- Description: - **Framework Integration**: Demonstrates a local implementation of a ChatPDF system using **LangChain** for LLM orchestration and **Ollama** for local LLM inference.
...
- Stars: 0
- Language: Unknown
- Description: - **Educational RAG Implementation**: Provides a step-by-step guide to building Retrieval-Augmented Generation (RAG) systems from scratch using local LLMs, emphasizing transparency by avoiding blac...
...
### 17. [HKUDS/MiniRAG](../ai/rag/hkuds-minirag.md) ([GitHub](https://github.com/hkuds/minirag))
- Stars: 0
- Language: Unknown
- Description: - **Proposes MiniRAG**: A simplified RAG framework leveraging small, open-sourced language models (SLMs) to reduce computational overhead while maintaining performance, targeting ACL 2026.
