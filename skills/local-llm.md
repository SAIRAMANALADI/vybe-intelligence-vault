...
- [ray-project/llm-applications](../ai/rag/ray-project-llm-applications.md) (Source: Unknown Source) - Collected 2026-09-01
- [vndee/local-assistant-examples](../ai/rag/vndee-local-assistant-examples.md) (Source: Unknown Source) - Collected 2026-09-01
- [Tencent/WeKnora](../ai/rag/tencent-weknora.md) (Source: Unknown Source) - Collected 2026-09-01
...
- Stars: 0
- Language: Unknown
- Description: - **Implementation**: Demonstrates building a local ChatPDF system using Python, LangChain, and Ollama, leveraging Retrieval-Augmented Generation (RAG) for document interaction.
...
- Stars: 0
- Language: Unknown
- Description: - **Multi-modal LLM Knowledge Platform**: Converts raw documents into a queryable RAG system, autonomous reasoning agent, and self-maintaining Wiki using Go, supporting embeddings, vector search, a...
...
- Stars: 0
- Language: Unknown
- Description: - **Multi-Agent Architecture**: Implements a CrewAI-based system with FastAPI to enable collaborative agent interactions, supporting both remote (GPT) and local (Ollama) LLM integrations.
