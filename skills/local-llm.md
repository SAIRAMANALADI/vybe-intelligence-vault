...
- [facebookresearch/faiss](../ai/rag/facebookresearch-faiss.md) (Source: Unknown Source) - Collected 2026-08-03
- [NanGePlus/CrewAITest](../ai/agents/nangeplus-crewaitest.md) (Source: Unknown Source) - Collected 2026-08-03
...
- Stars: 0
- Language: Unknown
- Description: - **Purpose**: Provides a Python-based framework to locally deploy a ChatPDF application using LangChain, LLMs, and Ollama with RAG capabilities.
...
- Stars: 0
- Language: Unknown
- Description: - **Multi-functional LLM Platform**: Transforms raw documents into a **queryable RAG (Retrieval-Augmented Generation)**, an **autonomous reasoning agent**, and a **self-maintaining Wiki** with sema...
...
- Stars: 0
- Language: Unknown
- Description: - **Local LLM Integration**: Demonstrates end-to-end RAG pipeline using locally hosted LLMs (e.g., Llama, Mistral) via Ollama or vLLM for privacy and cost efficiency.
...
### 14. [HKUDS/MiniRAG](../ai/rag/hkuds-minirag.md) ([GitHub](https://github.com/hkuds/minirag))
- Stars: 0
- Language: Unknown
- Description: - **Miniaturized RAG Framework**: Introduces a simplified RAG pipeline leveraging small, open-source language models (SLMs) to reduce computational overhead while maintaining competitive performanc...
