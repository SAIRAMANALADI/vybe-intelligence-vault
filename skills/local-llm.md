...
- [pguso/ai-agents-from-scratch](../ai/agents/pguso-ai-agents-from-scratch.md) (Source: Unknown Source) - Collected 2026-08-09
- [QuivrHQ/quivr](../ai/rag/quivrhq-quivr.md) (Source: Unknown Source) - Collected 2026-08-09
...
- Stars: 0
- Language: Unknown
- Description: - **Purpose**: Demonstrates building a local ChatPDF application using Python, LangChain, and Ollama for LLM integration.
...
- Stars: 0
- Language: Unknown
- Description: - **Multi-functional LLM Platform**: Converts raw documents into a queryable RAG system, autonomous reasoning agent, and self-maintaining Wiki using Go, supporting multi-tenancy and multi-model int...

### 9. [stackitcloud/rag-template](../ai/rag/stackitcloud-rag-template.md) ([GitHub](https://github.com/stackitcloud/rag-template))
- Stars: 0
- Language: Unknown
- Description: - **RAG Pipeline**: Implements Retrieval-Augmented Generation (RAG) with vector search for document retrieval and FastAPI for serving AI chatbots.

### 10. [pguso/rag-from-scratch](../ai/rag/pguso-rag-from-scratch.md) ([GitHub](https://github.com/pguso/rag-from-scratch))
- Stars: 0
- Language: Unknown
- Description: - **Educational RAG Implementation**: Provides a step-by-step guide to building a Retrieval-Augmented Generation (RAG) system from scratch using local LLMs, emphasizing transparency by avoiding bla...

### 11. [pixegami/rag-tutorial-v2](../ai/rag/pixegami-rag-tutorial-v2.md) ([GitHub](https://github.com/pixegami/rag-tutorial-v2))
- Stars: 0
- Language: Unknown
- Description: - **Local LLM Integration**: Demonstrates RAG implementation using local language models (e.g., Llama, Mistral) via Ollama or LM Studio, avoiding cloud API dependencies.
...
- Stars: 0
- Language: Unknown
- Description: - **Python SDK** for AI agent monitoring, LLM cost tracking, and benchmarking with support for **CrewAI, Agno, OpenAI Agents SDK, LangChain, AutoGen, AG2, and CamelAI**.
...
- Stars: 0
- Language: Unknown
- Description: - **Educational repository** demonstrating the construction of AI agents from scratch using JavaScript, focusing on local LLMs (via `node-llama-cpp`) to avoid black-box dependencies.
