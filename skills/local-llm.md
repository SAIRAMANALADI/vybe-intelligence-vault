...
Active signals: 243 resources matched in the intelligence vault.
Recently detected signals:
- [GitHub - weaviate/Verba: Retrieval Augmented Generation (RAG) chatbot powered by Weaviate · GitHub](../ai/rag/weaviate-verba.md) (Source: Unknown Source) - Collected 2026-07-21
- [AgentOps-AI/agentops](../ai/agents/agentops-ai-agentops.md) (Source: Unknown Source) - Collected 2026-07-21
- [pguso/ai-agents-from-scratch](../ai/agents/pguso-ai-agents-from-scratch.md) (Source: Unknown Source) - Collected 2026-07-21
- [IntelLabs/fastRAG](../ai/rag/intellabs-fastrag.md) (Source: Unknown Source) - Collected 2026-07-21
- [vndee/local-assistant-examples](../ai/rag/vndee-local-assistant-examples.md) (Source: Unknown Source) - Collected 2026-07-21
...
### 2. [GitHub - weaviate/Verba: Retrieval Augmented Generation (RAG) chatbot powered by Weaviate · GitHub](../ai/rag/weaviate-verba.md) ([GitHub](https://github.com/weaviate/verba))
- Stars: 0
- Language: Unknown
...
- Stars: 0
- Language: Unknown
- Description: - **Implementation**: Demonstrates building a local ChatPDF application using Python, LangChain, and Ollama for LLM integration.
...
- Stars: 0
- Language: Unknown
- Description: - **Multi-Model RAG & Agent Framework**: Go-based open-source platform enabling raw document ingestion, vector embeddings, and retrieval-augmented generation (RAG) with autonomous reasoning agents ...
...
- Stars: 0
- Language: Unknown
- Description: - **Educational RAG Implementation**: Provides a step-by-step JavaScript-based tutorial for building Retrieval-Augmented Generation (RAG) systems from scratch using local LLMs (via `node-llama-cpp`...
...
- Stars: 0
- Language: Unknown
- Description: - **Python SDK** for comprehensive **AI agent monitoring**, **LLM cost tracking**, and **benchmarking**, supporting frameworks like CrewAI, Agno, OpenAI Agents SDK, LangChain, AutoGen, AG2, and Cam...
...
### 15. [IntelLabs/fastRAG](../ai/rag/intellabs-fastrag.md) ([GitHub](https://github.com/intellabs/fastrag))
- Stars: 0
- Language: Unknown
- Description: - **Framework Overview**: FastRAG is an efficient, Python-based framework for Retrieval Augmented Generation (RAG) optimized for low-latency, high-throughput applications, supporting multi-modal in...
...
- Stars: 0
- Language: Unknown
- Description: - **Optimized similarity search**: FAISS provides highly efficient algorithms for searching dense vectors in high-dimensional spaces, leveraging techniques like **IVF (Inverted File Index)** and **...
