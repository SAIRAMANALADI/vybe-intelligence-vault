...
- [Introducing EmbeddingGemma: The Best-in-Class Open Model for On-Device Embeddings - Google Developers Blog](../ai/rag/introducing-embeddinggemma-the-best-in-class-open.md) (Source: Unknown Source) - Collected 2026-07-20
- [llmware-ai/llmware](../ai/rag/llmware-ai-llmware.md) (Source: Unknown Source) - Collected 2026-07-20
- [AgentOps-AI/agentops](../ai/agents/agentops-ai-agentops.md) (Source: Unknown Source) - Collected 2026-07-20
- [QuivrHQ/quivr](../ai/rag/quivrhq-quivr.md) (Source: Unknown Source) - Collected 2026-07-20
- [vndee/local-assistant-examples](../ai/rag/vndee-local-assistant-examples.md) (Source: Unknown Source) - Collected 2026-07-20
...
- Stars: 0
- Language: Unknown
- Description: - **Purpose**: Demonstrates building a local ChatPDF application using Python, LangChain, and Ollama for LLM integration and RAG (Retrieval-Augmented Generation) workflows.
...
- Stars: 0
- Language: Unknown
- Description: - **Implementation**: Demonstrates Retrieval-Augmented Generation (RAG) pipeline in JavaScript using `node-llama-cpp` for local LLMs, emphasizing transparency by avoiding proprietary APIs.
...
- Stars: 0
- Language: Unknown
- Description: - **Purpose**: Provides a template for deploying AI chatbots and document management systems using Retrieval-Augmented Generation (RAG) with vector search capabilities.
...
- Stars: 0
- Language: Unknown
- Description: *   Transforms raw documents into an integrated LLM knowledge platform comprising a queryable R
...
- Stars: 0
- Language: Unknown
- Description: - **Local LLM Integration**: Demonstrates implementation of Retrieval-Augmented Generation (RAG) using local language models (LLMs) for offline inference, reducing dependency on cloud-based APIs.

### 12. [microsoft/rag-time](../ai/rag/microsoft-rag-time.md) ([GitHub](https://github.com/microsoft/rag-time))
- Stars: 0
- Language: Unknown
- Description: - **5-week structured curriculum** covering advanced RAG techniques including hybrid search (vector + keyword), binary/scalar quantization, and HNSW indexing for efficient retrieval in Azure enviro...

### 13. [AgentOps-AI/agentops](../ai/agents/agentops-ai-agentops.md) ([GitHub](https://github.com/agentops-ai/agentops))
- Stars: 0
- Language: Unknown
- Description: - **Multi-Framework Integration**: Python SDK providing monitoring, cost tracking, and benchmarking for AI agents, compatible with frameworks like CrewAI, LangChain, Autogen, OpenAI Agents SDK, Agn...
...
### 15. [QuivrHQ/quivr](../ai/rag/quivrhq-quivr.md) ([GitHub](https://github.com/quivrhq/quivr))
- Stars: 0
- Language: Unknown
...
### 19. [microsoft/tutel](../ai/resources/microsoft-tutel.md) ([GitHub](https://github.com/microsoft/tutel))
- Stars: 0
- Language: Unknown
