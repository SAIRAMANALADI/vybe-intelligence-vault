...
- [LLM: A CLI utility and Python library for interacting with Large Language Models](../ai/rag/llm-a-cli-utility-and-python-library-for-interacti.md) (Source: Unknown Source) - Collected 2026-08-04
- [AgentOps-AI/agentops](../ai/agents/agentops-ai-agentops.md) (Source: Unknown Source) - Collected 2026-08-04
- [continuedev/continue](../ai/agents/continuedev-continue.md) (Source: Unknown Source) - Collected 2026-08-04
- [QuivrHQ/quivr](../ai/rag/quivrhq-quivr.md) (Source: Unknown Source) - Collected 2026-08-04
- [vndee/local-assistant-examples](../ai/rag/vndee-local-assistant-examples.md) (Source: Unknown Source) - Collected 2026-08-04
...
- Stars: 0
- Language: Unknown
- Description: - **Multi-Model RAG & Agent Framework**: Implements Retrieval-Augmented Generation (RAG) with support for OpenAI, Ollama, and custom embeddings, enabling queryable knowledge bases, autonomous reaso...
...
### 11. [rosgluk (Rost Glukhov) · GitHub](../ai/agents/rosgluk-rost-glukhov-github.md) ([GitHub](https://github.com/rosgluk))
- Stars: 0
- Language: Unknown
...
- Stars: 0
- Language: Unknown
- Description: - **RAG Mastery Curriculum**: A structured 5-week program in Jupyter Notebooks covering Retrieval-Augmented Generation (RAG) fundamentals, hybrid search (vector + keyword), and advanced techniques ...
...
- Stars: 0
- Language: Unknown
- Description: - **Python SDK** for **AI agent monitoring**, **LLM cost tracking**, **benchmarking**, and **evaluation metrics** with support for **multi-agent frameworks** (CrewAI, Agno, OpenAI Agents SDK, LangC...
...
### 16. [QuivrHQ/quivr](../ai/rag/quivrhq-quivr.md) ([GitHub](https://github.com/quivrhq/quivr))
- Stars: 0
- Language: Unknown
...
- Stars: 0
- Language: Unknown
- Description: - **Multi-LLM Integration**: Supports seamless interaction with any Large Language Model (LLM) via a unified API, enabling cross-model compatibility and dynamic switching between providers (e.g., O...
...
### 22. [huggingface/text-embeddings-inference](../ai/rag/huggingface-text-embeddings-inference.md) ([GitHub](https://github.com/huggingface/text-embeddings-inference))
- Stars: 0
- Language: Unknown
