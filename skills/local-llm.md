...
- [Installation - vLLM](../ai/resources/installation-vllm.md) (Source: Unknown Source) - Collected 2026-08-03
- [RAG · Hugging Face](../ai/rag/huggingface-transformers-master.md) (Source: Unknown Source) - Collected 2026-08-03
- [llmware-ai/llmware](../ai/rag/llmware-ai-llmware.md) (Source: Unknown Source) - Collected 2026-08-03
...
- Stars: 0
- Language: Unknown
- Description: - **Purpose**: Demonstrates building a local ChatPDF application using LangChain, LLMs (via Ollama), and RAG (Retrieval-Augmented Generation) for document interaction.
...
- Stars: 0
- Language: Unknown
- Description: - **Multi-Functional LLM Platform**: WeKnora transforms raw documents into a **queryable RAG system**, an **autonomous reasoning agent**, and a **self-maintaining Wiki**, supporting **multi-tenant*...

### 8. [eosphoros-ai/DB-GPT](../ai/rag/eosphoros-ai-db-gpt.md) ([GitHub](https://github.com/eosphoros-ai/db-gpt))
- Stars: 0
- Language: Unknown
- Description: - **Purpose**: Open-source agentic AI framework designed to act as a data assistant for next-gen AI + Data products, enabling natural language interaction with databases via LLMs (e.g., GPT-4, Deep...
...
### 16. [ragas/docs/getstarted/evals.md at main · vibrantlabsai/ragas · GitHub](../ai/rag/vibrantlabsai-ragas.md) ([GitHub](https://github.com/vibrantlabsai/ragas))
- Stars: 0
- Language: Unknown
...
### 17. [AgentOps-AI/agentops](../ai/agents/agentops-ai-agentops.md) ([GitHub](https://github.com/agentops-ai/agentops))
- Stars: 0
- Language: Unknown
- Description: - **Python SDK** for monitoring AI agents, tracking LLM costs, and benchmarking, with integrations across frameworks like CrewAI, LangChain, Autogen, and OpenAI Agents SDK.
