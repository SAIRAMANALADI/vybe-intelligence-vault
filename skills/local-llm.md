...
- [facebookresearch/faiss](../ai/rag/facebookresearch-faiss.md) (Source: Unknown Source) - Collected 2026-08-02
- [Evaluate a simple LLM application - Ragas](../ai/rag/evaluate-a-simple-llm-application-ragas.md) (Source: Unknown Source) - Collected 2026-08-02
...
- Stars: 0
- Language: Unknown
- Description: - **Multi-modal RAG & Agent Framework**: WeKnora transforms raw documents into a queryable Retrieval-Augmented Generation (RAG) system, supports autonomous reasoning agents, and maintains a self-up...

### 6. [pguso/rag-from-scratch](../ai/rag/pguso-rag-from-scratch.md) ([GitHub](https://github.com/pguso/rag-from-scratch))
- Stars: 0
- Language: Unknown
- Description: - Implements Retrieval-Augmented Generation (RAG) pipeline from scratch using JavaScript, avoiding proprietary LLM APIs for full transparency.
...
- Stars: 0
- Language: Unknown
- Description: - Implements **LangChain-based RAG pipeline** with **local LLMs** (e.g., Llama, Mistral) via Ollama or vLLM for offline inference.
...
- Stars: 0
- Language: Unknown
- Description: - **Learning Path**: 5-week structured curriculum covering RAG fundamentals, hybrid search (vector + keyword), quantization (binary/scalar), and Matryoshka representation learning for efficient LLM...
...
- Stars: 0
- Language: Unknown
- Description: - **Efficient similarity search**: FAISS provides optimized algorithms for searching dense vectors in high-dimensional spaces with sublinear time complexity, leveraging techniques like **inverted f...
