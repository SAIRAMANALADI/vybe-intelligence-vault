...
- [PHMForge: Evaluating LLM Agents on Industrial Prognostics through MCP-Native, Algorithm-Grounded Tools](../ai/rag/arxiv-2604-01532.md) (Source: Unknown Source) - Collected 2026-08-28
- [Hybrid Semantic Tool Discovery for Enterprise MCP Gateway: Architecture and Implementation](../ai/rag/arxiv-2608-23992.md) (Source: Unknown Source) - Collected 2026-08-28
- [Beyond the Mandate: A Systematic Security Analysis of the Agent Payments Protocol (AP2)](../ai/agents/arxiv-2608-23858.md) (Source: Unknown Source) - Collected 2026-08-28
- [TrustShiftProbe: Characterizing, Benchmarking, and Defending Staged Trust Attacks on MCP Servers](../ai/agents/arxiv-2608-23763.md) (Source: Unknown Source) - Collected 2026-08-28
- [How to Build an MCP Server with Gradio](../ai/models/huggingface-blog-gradio-mcp.md) (Source: Unknown Source) - Collected 2026-08-28
...
### 17. [Pinecone · GitHub](../ai/rag/pinecone-github.md) ([GitHub](https://github.com/pinecone-io))
- Stars: 0
- Language: Unknown
...
- Stars: 0
- Language: Unknown
- Description: *   HexStrike AI is an advanced MCP server enabling autonomous execution of 150+ cybersecurity tools by AI agents (e.g., Claude, GPT) for offensive operations.
...
- Stars: 0
- Language: Unknown
- Description: - **AI Agent Security Scanner**: Detects vulnerabilities in agent configurations, MCP servers, and tool permissions with multiple integration options (CLI, GitHub Action, ECC plugin, GitHub App).
...
### 49. [Ed1s0nZ/CyberStrikeAI](../ai/agents/ed1s0nz-cyberstrikeai.md) ([GitHub](https://github.com/ed1s0nz/cyberstrikeai))
- Stars: 0
- Language: Unknown
