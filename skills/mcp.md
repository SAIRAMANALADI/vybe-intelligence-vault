...
- [Home - Google Developers Blog](../ai/rag/home-google-developers-blog.md) (Source: Unknown Source) - Collected 2026-08-10
...
- Stars: 0
- Language: Unknown
- Description: - **Content Focus**: Repository provides advanced tutorials on Large Language Models (LLMs), Retrieval-Augmented Generation (RAG) systems, and real-world AI agent applications with practical implem...
...
- Stars: 0
- Language: Unknown
- Description: - **Multi-modal indexing & GraphRAG**: Implements a production-ready GraphRAG system with support for structured/unstructured data (text, images, etc.) and knowledge graph integration for enhanced ...
...
### 24. [uber/ADR](../ai/agents/uber-adr.md) ([GitHub](https://github.com/uber/adr))
- Stars: 0
- Language: Unknown
- Description: - **Purpose & Deployment**: ADR (Agent Defense Runtime) is an enterprise-grade security framework for AI agents, providing observability, security benchmarking, and threat detection; currently depl...
...
- Stars: 0
- Language: Unknown
- Description: - **Native Agent-Driven Development**: GitHub Copilot app integrates agent workflows directly into GitHub, supporting macOS, Windows, and Linux, with session isolation, built-in validation (diffs, ...
...
- Stars: 0
- Language: Unknown
- Description: - **Curated Resource**: A GitHub repository hosting a structured collection of GitHub Copilot AI enhancement materials, including instructions, prompts, skills, MCP (Model Context Protocol) configu...
