...
### 25. [ElevenLabs · GitHub](../ai/rag/elevenlabs-github.md) ([GitHub](https://github.com/elevenlabs))
- Stars: 0
- Language: Unknown
...
- Stars: 0
- Language: Unknown
- Description: *   MCP server orchestrates 150+ offensive security tools via AI agents (e.g., Claude, GPT) for autonomous execution.
