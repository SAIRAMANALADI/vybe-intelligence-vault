...
- [snyk/agent-scan](../ai/agents/snyk-agent-scan.md) (Source: Unknown Source) - Collected 2026-07-21
...
### 13. [firecrawl repositories · GitHub](../ai/rag/orgs-firecrawl.md) ([GitHub](https://github.com/orgs/firecrawl))
- Stars: 0
- Language: Unknown
...
- Stars: 0
- Language: Unknown
- Description: - **Repository Overview**: GitHub repository `patchy631/ai-engineering-hub` with 36,623 stars and 6,059 forks, focused on AI engineering tutorials using Jupyter Notebooks.
...
- Stars: 0
- Language: Unknown
- Description: - **Purpose**: GitMCP is an open-source, remote MCP (Model Context Protocol) server designed to provide AI agents with direct, real-time access to GitHub repositories, mitigating "code hallucinatio...
...
- Stars: 0
- Language: Unknown
- Description: *   HexStrike AI implements an advanced MCP server architecture to enable autonomous execution of 150+ cybersecurity tools by AI agents (e.g., Claude, GPT).
...
- Stars: 0
- Language: Unknown
- Description: - **Curated Resource**: Repository providing a structured collection of GitHub Copilot custom instructions, prompts, skills, MCP (Model Context Protocol) configurations, and agent markdown files to...
