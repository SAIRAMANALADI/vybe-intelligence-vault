...
Active signals: 4306 resources matched in the intelligence vault.
...
- [Agentic Search. More accurate and efficient results from your AI systems.](../ai/companies/mistral/agentic-search-more-accurate-and-efficient-results.md) (Source: Unknown Source) - Collected 2026-08-31
- [Building Next.js for an agentic future](../ai/agents/building-next-js-for-an-agentic-future.md) (Source: Unknown Source) - Collected 2026-08-31
- [Next.js 16.2: AI Improvements](../ai/agents/next-js-16-2-ai-improvements.md) (Source: Unknown Source) - Collected 2026-08-31
...
- Stars: 0
- Language: Unknown
- Description: *   Provides a high-performance, reliable template for rapid multi-agent application development.
...
### 10. [crewAIInc/awesome-crewai](../ai/rag/crewaiinc-awesome-crewai.md) ([GitHub](https://github.com/crewaiinc/awesome-crewai))
- Stars: 0
- Language: Unknown
...
### 11. [panaversity/langgraph-agents-template](../ai/agents/panaversity-langgraph-agents-template.md) ([GitHub](https://github.com/panaversity/langgraph-agents-template))
- Stars: 0
- Language: Unknown
...
- Stars: 0
- Language: Unknown
- Description: - **Multi-agent orchestration framework** in Python for building resilient, stateful AI agents with support for parallel and sequential workflows, state management, and tool integration.

### 13. [crewAIInc/crewAI](../ai/rag/crewaiinc-crewai.md) ([GitHub](https://github.com/crewaiinc/crewai))
- Stars: 0
- Language: Unknown
- Description: - **Role-based Agent Orchestration**: CrewAI enables autonomous AI agents to collaborate via role-playing, assigning specialized functions (e.g., researcher, writer) to optimize task execution thro...
...
- Stars: 0
- Language: Unknown
- Description: *   Integrates FastAPI with LangGraph and LangChain for building scalable, production-ready AI agent applications.
...
- Stars: 0
- Language: Unknown
- Description: *   Explores Langgraph framework for developing agentic AI systems.
...
- Stars: 0
- Language: Unknown
- Description: *   Jupyter Notebook collection demonstrating CrewAI agentic workflow implementations and tool integration.
...
### 22. [lgesuellip/langgraph-whatsapp-agent](../ai/agents/lgesuellip-langgraph-whatsapp-agent.md) ([GitHub](https://github.com/lgesuellip/langgraph-whatsapp-agent))
- Stars: 0
- Language: Unknown
...
### 35. [MARKTECHPOST-AI-MEDIA-INC/AI-Agents-Projects-Tutorials](../ai/rag/marktechpost-ai-media-inc-ai-agents-projects-tutorials.md) ([GitHub](https://github.com/marktechpost-ai-media-inc/ai-agents-projects-tutorials))
- Stars: 0
- Language: Unknown
...
- Stars: 0
- Language: Unknown
- Description: *   Comprehensive repository of 50+ GenAI agent implementations, ranging from foundational conversational bots to complex multi-agent systems.
...
### 40. [cloudflare/agentic-inbox](../ai/rag/cloudflare-agentic-inbox.md) ([GitHub](https://github.com/cloudflare/agentic-inbox))
- Stars: 0
- Language: Unknown
