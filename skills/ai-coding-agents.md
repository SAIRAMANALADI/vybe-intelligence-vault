...
Active signals: 759 resources matched in the intelligence vault.
...
- [datawhalechina/llm-universe](../ai/rag/datawhalechina-llm-universe.md) (Source: Unknown Source) - Collected 2026-06-16
...
### 6. [golf-mcp/golf](../ai/agents/golf-mcp-golf.md) ([GitHub](https://github.com/golf-mcp/golf))
- Stars: 0
- Language: Unknown
...
### 7. [ChiggyJain/PythonLangSmithTutorial](../ai/rag/chiggyjain-pythonlangsmithtutorial.md) ([GitHub](https://github.com/chiggyjain/pythonlangsmithtutorial))
- Stars: 0
- Language: Unknown
...
### 10. [AlexPEClub/ai-coding-starter-kit](../ai/agents/alexpeclub-ai-coding-starter-kit.md) ([GitHub](https://github.com/alexpeclub/ai-coding-starter-kit))
- Stars: 0
- Language: Unknown
- Description: Production-ready Next.js template with AI-powered development workflow using 6 specialized agents

### 11. [danielt69/awesome-agent-observability](../ai/agents/danielt69-awesome-agent-observability.md) ([GitHub](https://github.com/danielt69/awesome-agent-observability))
- Stars: 0
- Language: Unknown
- Description: A curated list of tools for observability, evaluation, tracing, and guardrails of production LLM agents.

### 12. [humanlayer/12-factor-agents](../ai/rag/humanlayer-12-factor-agents.md) ([GitHub](https://github.com/humanlayer/12-factor-agents))
- Stars: 0
- Language: Unknown
...
### 13. [modelscope/evalscope](../ai/rag/modelscope-evalscope.md) ([GitHub](https://github.com/modelscope/evalscope))
- Stars: 0
- Language: Unknown
...
### 14. [onejune2018/Awesome-LLM-Eval](../ai/rag/onejune2018-awesome-llm-eval.md) ([GitHub](https://github.com/onejune2018/awesome-llm-eval))
- Stars: 0
- Language: Unknown
...
### 21. [ChinskiKaczynski/Awesome-OpenAI-Agent-Templates](../ai/agents/chinskikaczynski-awesome-openai-agent-templates.md) ([GitHub](https://github.com/chinskikaczynski/awesome-openai-agent-templates))
- Stars: 0
- Language: Unknown
...
### 22. [infiniflow/ragflow](../ai/rag/infiniflow-ragflow.md) ([GitHub](https://github.com/infiniflow/ragflow))
- Stars: 0
- Language: Unknown
...
### 26. [pguso/rag-from-scratch](../ai/rag/pguso-rag-from-scratch.md) ([GitHub](https://github.com/pguso/rag-from-scratch))
- Stars: 0
- Language: Unknown
...
### 27. [ilexistools/agents-sdk-templates](../ai/agents/ilexistools-agents-sdk-templates.md) ([GitHub](https://github.com/ilexistools/agents-sdk-templates))
- Stars: 0
- Language: Unknown
...
### 31. [flashinfer-ai/flashinfer-bench-starter-kit](../ai/agents/flashinfer-ai-flashinfer-bench-starter-kit.md) ([GitHub](https://github.com/flashinfer-ai/flashinfer-bench-starter-kit))
- Stars: 0
- Language: Unknown
- Description: FlashInfer Bench @ MLSys 2026: Building AI agents to write high performance GPU kernels

### 32. [i-am-bee/beeai-framework](../ai/agents/i-am-bee-beeai-framework.md) ([GitHub](https://github.com/i-am-bee/beeai-framework))
- Stars: 0
- Language: Unknown
...
### 35. [redhat-data-and-ai/template-agent](../ai/agents/redhat-data-and-ai-template-agent.md) ([GitHub](https://github.com/redhat-data-and-ai/template-agent))
- Stars: 0
- Language: Unknown
...
### 36. [SonarSource/sonarqube-mcp-server](../ai/agents/sonarsource-sonarqube-mcp-server.md) ([GitHub](https://github.com/sonarsource/sonarqube-mcp-server))
- Stars: 0
- Language: Unknown
- Description: Official SonarQube MCP Server for code quality and security in AI agents

### 37. [wassim249/fastapi-langgraph-agent-production-ready-template](../ai/agents/wassim249-fastapi-langgraph-agent-production-ready-template.md) ([GitHub](https://github.com/wassim249/fastapi-langgraph-agent-production-ready-template))
- Stars: 0
- Language: Unknown
...
### 41. [fzn0x/watchtower](../ai/rag/fzn0x-watchtower.md) ([GitHub](https://github.com/fzn0x/watchtower))
- Stars: 0
- Language: Unknown
...
### 43. [our-never-ending-job/awesome-rag-debugging](../ai/rag/our-never-ending-job-awesome-rag-debugging.md) ([GitHub](https://github.com/our-never-ending-job/awesome-rag-debugging))
- Stars: 0
- Language: Unknown
...
### 44. [TIMAN-group/PlugMem](../ai/rag/timan-group-plugmem.md) ([GitHub](https://github.com/timan-group/plugmem))
- Stars: 0
- Language: Unknown
...
### 46. [saasykits/nextjs-sessionauth-template](../web-development/nextjs/saasykits-nextjs-sessionauth-template.md) ([GitHub](https://github.com/saasykits/nextjs-sessionauth-template))
- Stars: 0
- Language: Unknown
- Description: Next.js starter template featuring session-based auth, drizzle-orm, tailwind, shadcn ui, stripe, react-email etc.
...
Auto-updated by Local AI + Web Harvester on 2026-06-16T11:24:31.493168+05:30.
