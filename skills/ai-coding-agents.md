...
Active signals: 635 resources matched in the intelligence vault.
...
### 3. [sjseo298/spring-ai-template](../ai/rag/sjseo298-spring-ai-template.md) ([GitHub](https://github.com/sjseo298/spring-ai-template))
- Stars: 0
- Language: Unknown
...
### 8. [golf-mcp/golf](../ai/agents/golf-mcp-golf.md) ([GitHub](https://github.com/golf-mcp/golf))
- Stars: 0
- Language: Unknown
...
### 14. [danielt69/awesome-agent-observability](../ai/agents/danielt69-awesome-agent-observability.md) ([GitHub](https://github.com/danielt69/awesome-agent-observability))
- Stars: 0
- Language: Unknown
...
### 16. [modelscope/evalscope](../ai/rag/modelscope-evalscope.md) ([GitHub](https://github.com/modelscope/evalscope))
- Stars: 0
- Language: Unknown
...
### 20. [TencentCloudADP/youtu-graphrag](../ai/rag/tencentcloudadp-youtu-graphrag.md) ([GitHub](https://github.com/tencentcloudadp/youtu-graphrag))
- Stars: 0
- Language: Unknown
...
### 24. [ChinskiKaczynski/Awesome-OpenAI-Agent-Templates](../ai/agents/chinskikaczynski-awesome-openai-agent-templates.md) ([GitHub](https://github.com/chinskikaczynski/awesome-openai-agent-templates))
- Stars: 0
- Language: Unknown
...
### 25. [infiniflow/ragflow](../ai/rag/infiniflow-ragflow.md) ([GitHub](https://github.com/infiniflow/ragflow))
- Stars: 0
- Language: Unknown
...
### 33. [FailproofAI/ai-reliability-standards](../ai/agents/failproofai-ai-reliability-standards.md) ([GitHub](https://github.com/failproofai/ai-reliability-standards))
- Stars: 0
- Language: Unknown
...
### 38. [nottelabs/open-operator-evals](../ai/agents/nottelabs-open-operator-evals.md) ([GitHub](https://github.com/nottelabs/open-operator-evals))
- Stars: 0
- Language: Unknown
- Description: Opensource benchmark evaluating web operators/agents performance

### 39. [redhat-data-and-ai/template-agent](../ai/agents/redhat-data-and-ai-template-agent.md) ([GitHub](https://github.com/redhat-data-and-ai/template-agent))
- Stars: 0
- Language: Unknown
...
### 40. [SonarSource/sonarqube-mcp-server](../ai/agents/sonarsource-sonarqube-mcp-server.md) ([GitHub](https://github.com/sonarsource/sonarqube-mcp-server))
- Stars: 0
- Language: Unknown
- Description: Official SonarQube MCP Server for code quality and security in AI agents

### 41. [wassim249/fastapi-langgraph-agent-production-ready-template](../ai/agents/wassim249-fastapi-langgraph-agent-production-ready-template.md) ([GitHub](https://github.com/wassim249/fastapi-langgraph-agent-production-ready-template))
- Stars: 0
- Language: Unknown
...
Auto-updated by Local AI + Web Harvester on 2026-06-16T17:33:07.962828+05:30.444093+05:30.493168+05:30.
