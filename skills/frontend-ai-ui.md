...
- [vercel/ai](../ai/agents/vercel-ai.md) (Source: Unknown Source) - Collected 2026-06-30
- [rsrohan99/rag-stream-intermediate-events-tutorial](../ai/rag/rsrohan99-rag-stream-intermediate-events-tutorial.md) (Source: Unknown Source) - Collected 2026-06-30
...
- Stars: 0
- Language: Unknown
- Description: - **Intermediate Events Streaming**: Demonstrates how to stream intermediate events from LlamaIndex RAG pipelines to the Vercel AI SDK using Server-Sent Events (SSE) for real-time updates.
