...
- [vercel/ai](../ai/agents/vercel-ai.md) (Source: Unknown Source) - Collected 2026-08-02
- [vercel-labs/open-agents](../ai/rag/vercel-labs-open-agents.md) (Source: Unknown Source) - Collected 2026-08-02
- [vercel-labs/ai-sdk-preview-rag](../ai/rag/vercel-labs-ai-sdk-preview-rag.md) (Source: Unknown Source) - Collected 2026-08-02
- [rsrohan99/rag-stream-intermediate-events-tutorial](../ai/rag/rsrohan99-rag-stream-intermediate-events-tutorial.md) (Source: Unknown Source) - Collected 2026-08-02
...
### 1. [vercel-labs/open-agents](../ai/rag/vercel-labs-open-agents.md) ([GitHub](https://github.com/vercel-labs/open-agents))
- Stars: 0
- Language: Unknown
- Description: - **Template Purpose**: Provides a TypeScript-based open-source framework for building cloud-native AI agents and background agents, leveraging Vercel's infrastructure.
...
- Stars: 0
- Language: Unknown
- Description: - **RAG Implementation**: Template leverages the Vercel AI SDK to demonstrate retrieval-augmented generation (RAG) workflows, integrating document retrieval with LLM inference.
...
- Stars: 0
- Language: Unknown
- Description: - **Implementation**: Demonstrates streaming intermediate RAG events from LlamaIndex to Vercel AI SDK using Server-Sent Events (SSE) for real-time processing.
