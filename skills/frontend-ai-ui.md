...
- [Azure-Samples/azure-openai-rag-workshop-template](../ai/rag/azure-samples-azure-openai-rag-workshop-template.md) (Source: Unknown Source) - Collected 2026-08-06
...
- [SylphAI-Inc/GithubChat](../ai/rag/sylphai-inc-githubchat.md) (Source: Unknown Source) - Collected 2026-08-06
...
- Stars: 0
- Language: Unknown
- Description: - Demonstrates streaming intermediate LlamaIndex RAG events to Vercel AI SDK using Server-Sent Events (SSE) for real-time processing.
...
- Stars: 0
- Language: Unknown
- Description: - **AI SDK**: Open-source TypeScript library for building AI-powered applications and agents, developed by Vercel (creators of Next.js), supporting LLMs (OpenAI, Anthropic, Gemini) and generative U...

### 5. [SylphAI-Inc/GithubChat](../ai/rag/sylphai-inc-githubchat.md) ([GitHub](https://github.com/sylphai-inc/githubchat))
- Stars: 0
- Language: Unknown
- Description: - **Purpose**: Enables local RAG (Retrieval-Augmented Generation) for querying and interacting with GitHub repositories via a chat interface.
