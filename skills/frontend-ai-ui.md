...
- Stars: 0
- Language: Unknown
- Description: - **Purpose**: Provides a workshop template for building a Retrieval-Augmented Generation (RAG) chat application using Azure OpenAI services.
...
- Stars: 0
- Language: Unknown
- Description: - Demonstrates streaming intermediate LlamaIndex RAG events to Vercel AI SDK via Server-Sent Events (SSE) for real-time client updates.
...
- Stars: 0
- Language: Unknown
- Description: - **AI SDK Overview**: Open-source TypeScript library by Vercel for building AI-powered apps and agents, supporting models like Anthropic, OpenAI, and Gemini.
