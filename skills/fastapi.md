...
Active signals: 352 resources matched in the intelligence vault.
Recently detected signals:
- [DRL: A Deterministic Relational Middleware Layer for Transaction-Safe Enterprise NL2SQL Under Schema-Graph Scaling](../ai/research/arxiv-2608-26172.md) (Source: Unknown Source) - Collected 2026-08-30
- [DSA: Evidence-Aware LLM-Agent Orchestration for Multi-Market Stock Research](../ai/agents/arxiv-2608-26990.md) (Source: Unknown Source) - Collected 2026-08-30
- [A Safety-Gated Multimodal AI Backend for Mental-Health Support: Hierarchical State Representation, Conservative Risk Fusion, and Controlled Generation in Anian](../ai/research/arxiv-2608-26162.md) (Source: Unknown Source) - Collected 2026-08-30
- [Quanto: a PyTorch quantization backend for Optimum](../ai/models/huggingface-blog-quanto-introduction.md) (Source: Unknown Source) - Collected 2026-08-30
- [Introducing multi-backends (TRT-LLM, vLLM) support for Text Generation Inference](../ai/models/huggingface-blog-tgi-multi-backend.md) (Source: Unknown Source) - Collected 2026-08-30
...
- Stars: 0
- Language: Unknown
- Description: - **Repository Overview**: A GitHub agent built using Python and Pydantic for structured AI agent development, documented in a YouTube series covering end-to-end agent creation from concept to depl...
...
- Stars: 0
- Language: Unknown
- Description: - **Multi-agent & Enterprise Framework**: Open-source Python framework (`langchain`) for building AI agents, multi-agent systems, and enterprise-grade generative AI applications with support for LL...
...
### 18. [The-Swarm-Corporation/Multi-Agent-Template-App](../ai/agents/the-swarm-corporation-multi-agent-template-app.md) ([GitHub](https://github.com/the-swarm-corporation/multi-agent-template-app))
- Stars: 0
- Language: Unknown
...
### 22. [NanGePlus/CrewAITest](../ai/agents/nangeplus-crewaitest.md) ([GitHub](https://github.com/nangeplus/crewaitest))
- Stars: 0
- Language: Unknown
...
### 33. [goproxy/goproxy](../ai/rag/goproxy-goproxy.md) ([GitHub](https://github.com/goproxy/goproxy))
- Stars: 0
- Language: Unknown
...
### 34. [aomediacodec/libavif](../ai/rag/aomediacodec-libavif.md) ([GitHub](https://github.com/aomediacodec/libavif))
- Stars: 0
- Language: Unknown
...
### 35. [neondatabase/neon](../ai/rag/neondatabase-neon.md) ([GitHub](https://github.com/neondatabase/neon))
- Stars: 0
- Language: Unknown
...
### 38. [stanfordnlp/dspy](../ai/resources/stanfordnlp-dspy.md) ([GitHub](https://github.com/stanfordnlp/dspy))
- Stars: 0
- Language: Unknown
...
### 42. [docker/extensions-sdk](../ai/resources/docker-extensions-sdk.md) ([GitHub](https://github.com/docker/extensions-sdk))
- Stars: 0
- Language: Unknown
...
### 44. [CORE · GitHub](../ai/resources/core-github.md) ([GitHub](https://github.com/oacore))
- Stars: 0
- Language: Unknown
...
### 47. [apache/beam](../ai/resources/apache-beam.md) ([GitHub](https://github.com/apache/beam))
- Stars: 0
- Language: Unknown
...
### 48. [pypa/pip](../ai/resources/pypa-pip.md) ([GitHub](https://github.com/pypa/pip))
- Stars: 0
- Language: Unknown
