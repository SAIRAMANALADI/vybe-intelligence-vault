...
- Stars: 0
- Language: Unknown
- Description: - **Multi-agent orchestration framework**: LangChain provides a Python-based platform for building, deploying, and managing AI agents with support for multi-agent systems, workflows, and stateful i...
...
- Stars: 0
- Language: Unknown
- Description: - **Local LLM Integration**: Demonstrates implementation of Retrieval-Augmented Generation (RAG) using local language models (LLMs) for privacy and cost efficiency, leveraging frameworks like LangC...
...
- Stars: 0
- Language: Unknown
- Description: - **Curated Resource**: Aggregates GitHub Copilot instructions, prompts, skills, MCPs, and agent markdown files to optimize AI agent interactions.

### 12. [chaoql/rag-best-practices](../ai/rag/chaoql-rag-best-practices.md) ([GitHub](https://github.com/chaoql/rag-best-practices))
- Stars: 0
- Language: Unknown
- Description: - **Repository Overview**: A Python-based repository focused on best practices for Retrieval-Augmented Generation (RAG) techniques in large language models (LLMs).
...
- Stars: 0
- Language: Unknown
- Description: - **Curated Resource Hub**: GitHub repository (`awesome-copilot`) aggregating community-driven guides, agents, skills, and configurations to optimize GitHub Copilot usage.
