...
Active signals: 536 resources matched in the intelligence vault.
Recently detected signals:
- [LlamaIndex | AI Agents for Document OCR + Workflows](../ai/rag/llamaindex-ai-agents-for-document-ocr-workflows.md) (Source: Unknown Source) - Collected 2026-08-09
- [run-llama/llama-parse-go](../ai/resources/run-llama-llama-parse-go.md) (Source: Unknown Source) - Collected 2026-08-09
- [AI Document Parsing Software: AI-Ready Data at Scale | LlamaIndex](../ai/rag/ai-document-parsing-software-ai-ready-data-at-scal.md) (Source: Unknown Source) - Collected 2026-08-09
...
### 7. [mvanhorn/clawdbot-skill-manus](../ai/agents/mvanhorn-clawdbot-skill-manus.md) ([GitHub](https://github.com/mvanhorn/clawdbot-skill-manus))
- Stars: 0
- Language: Unknown
...
- Stars: 0
- Language: Unknown
- Description: - **Purpose-built RAG Optimization**: Provides a Python-based toolkit to design and deploy production-grade Retrieval Augmented Generation (RAG) pipelines, emphasizing end-to-end optimization for d...
...
- Stars: 0
- Language: Unknown
- Description: - **Curated Resource**: GitHub repository (`Code-and-Sorts/awesome-copilot-agents`) providing structured GitHub Copilot AI enhancements, including instructions, prompts, skills, MCPs, and agent mar...
...
- Stars: 0
- Language: Unknown
- Description: - **Curated Resources**: Repository aggregates community-driven guides, agents, skills, and configurations to optimize GitHub Copilot usage, covering prompt engineering, custom agents, and AI integ...
...
### 22. [run-llama/llama-parse-go](../ai/resources/run-llama-llama-parse-go.md) ([GitHub](https://github.com/run-llama/llama-parse-go))
- Stars: 0
- Language: Unknown
