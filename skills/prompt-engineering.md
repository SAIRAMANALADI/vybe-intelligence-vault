...
- [Learning to reason with LLMs | OpenAI](../ai/rag/learning-to-reason-with-llms-openai.md) (Source: Unknown Source) - Collected 2026-08-09
- [Prompt engineering | OpenAI API](../ai/rag/prompt-engineering-openai-api.md) (Source: Unknown Source) - Collected 2026-08-09
...
### 1. [NVIDIA/workbench-example-hybrid-rag](../ai/rag/nvidia-workbench-example-hybrid-rag.md) ([GitHub](https://github.com/nvidia/workbench-example-hybrid-rag))
- Stars: 0
- Language: Unknown
...
- Stars: 0
- Language: Unknown
- Description: - **Trilingual Learning Roadmap**: Curates 240+ resources spanning LLM fundamentals to multi-agent systems, with hands-on Python examples and support for Traditional Chinese, English, and Simplifie...
...
- Stars: 0
- Language: Unknown
- Description: - **Agentic AI Coding Assistants**: Analyzes reconstructed prompt patterns and agent coordination mechanisms for autonomous AI-driven code generation and debugging workflows.
...
- Stars: 0
- Language: Unknown
- Description: - **AI SDK**: Open-source TypeScript library by Vercel for building AI-powered apps and agents, supporting LLMs (OpenAI, Anthropic, Gemini), React, Next.js, Vue, and Svelte.
