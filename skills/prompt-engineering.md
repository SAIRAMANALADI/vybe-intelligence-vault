...
Active signals: 490 resources matched in the intelligence vault.
Recently detected signals:
- [Research | OpenAI](../ai/rag/research-openai.md) (Source: Unknown Source) - Collected 2026-08-04
...
- [ChatVertexAI integration - Docs by LangChain](../ai/agents/chatvertexai-integration-docs-by-langchain.md) (Source: Unknown Source) - Collected 2026-08-04
...
- Stars: 0
- Language: Unknown
- Description: - **Comprehensive 2026 AI Agent Guide**: Covers LangChain, LangGraph, Coze, Dify, MCP, LLM, RAG, and prompt engineering, structured for enterprise-level AI agent development and deployment.
...
- Stars: 0
- Language: Unknown
- Description: - **Comprehensive trilingual learning roadmap** for agentic AI, covering LLM fundamentals to multi-agent systems, with **240+ curated resources** and practical examples in Python.
...
- Stars: 0
- Language: Unknown
- Description: - **Curated Resources**: A community-driven repository offering instructions, agents, skills, and configurations to optimize GitHub Copilot usage, including prompt engineering techniques and custom...

### 11. [chaoql/rag-best-practices](../ai/rag/chaoql-rag-best-practices.md) ([GitHub](https://github.com/chaoql/rag-best-practices))
- Stars: 0
- Language: Unknown
- Description: - **Repository Overview**: Python-based repository (`chaoql/rag-best-practices`) focused on best practices for Retrieval-Augmented Generation (RAG) with large language models (LLMs), last updated J...
