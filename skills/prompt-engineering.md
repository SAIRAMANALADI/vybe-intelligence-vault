...
- [Opaque Epistemic Mediation: How LLM Deployment Configurations Shape the Validation of Pseudo-Science](../ai/research/arxiv-2607-22513.md) (Source: Unknown Source) - Collected 2026-07-28
- [The One-Word Census: Answer-Choice Conformity Across 44 Language Models](../ai/rag/arxiv-2607-12796.md) (Source: Unknown Source) - Collected 2026-07-28
- [LLM-Ideoplasticity: Measuring Ideological Plasticity in the Political Behavior of LLMs as a Context-Conditioned Distribution](../ai/research/arxiv-2606-28335.md) (Source: Unknown Source) - Collected 2026-07-28
- [Adaptive receptive field-based spatial-frequency feature reconstruction network for fine-grained few-shot image classification](../ai/research/arxiv-2604-16936.md) (Source: Unknown Source) - Collected 2026-07-28
- [CoopReflect: Towards Natural Language Communication for Cooperative Autonomous Driving via Multi-Agent Learning](../ai/agents/arxiv-2505-18334.md) (Source: Unknown Source) - Collected 2026-07-28
...
### 5. [h1papc11/healthcare-ai-agent-vault](../ai/agents/h1papc11-healthcare-ai-agent-vault.md) ([GitHub](https://github.com/h1papc11/healthcare-ai-agent-vault))
- Stars: 0
- Language: Unknown
- Description: - **Integration Framework**: Combines Obsidian templates, AI prompt workflows, and TypeScript preprocessing for structured Apple Health data ingestion and analysis.
...
- Stars: 0
- Language: Unknown
- Description: - **Curated Resources**: Repository aggregates GitHub Copilot enhancement materials, including instructions, prompts, skills, MCPs, and agent markdown files, optimized for AI agent interactions.
