...
- [vercel/ai](../ai/agents/vercel-ai.md) (Source: Unknown Source) - Collected 2026-08-08
- [didilili/ai-agents-from-zero](../ai/rag/didilili-ai-agents-from-zero.md) (Source: Unknown Source) - Collected 2026-08-08
...
### 5. [pixegami/langchain-rag-tutorial](../ai/rag/pixegami-langchain-rag-tutorial.md) ([GitHub](https://github.com/pixegami/langchain-rag-tutorial))
- Stars: 0
- Language: Unknown
...
- Stars: 0
- Language: Unknown
- Description: - **RAG Optimization Framework**: Implements retrieval-augmented generation (RAG) best practices for large language models (LLMs), focusing on retrieval efficiency, context relevance, and generatio...
...
- Stars: 0
- Language: Unknown
- Description: - **Agentic AI Coding Assistants**: Investigates prompt patterns, agent coordination mechanisms, and security classifications in agentic AI systems for coding tasks.
...
- Stars: 0
- Language: Unknown
- Description: - **Educational Resource**: A beginner-friendly tutorial series for developing large language model (LLM) applications, structured as Jupyter Notebooks, covering foundational to advanced topics in ...
