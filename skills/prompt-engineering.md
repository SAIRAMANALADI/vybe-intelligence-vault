...
- [run-llama/llama-cloud-ts](../ai/agents/run-llama-llama-cloud-ts.md) (Source: Unknown Source) - Collected 2026-08-03
- [Gemini API | Google AI for Developers](../ai/agents/gemini-api-google-ai-for-developers.md) (Source: Unknown Source) - Collected 2026-08-03
- [LangSmith Observability - Docs by LangChain](../ai/rag/langsmith-observability-docs-by-langchain.md) (Source: Unknown Source) - Collected 2026-08-03
...
- [NousResearch/hermes-agent](../ai/agents/nousresearch-hermes-agent.md) (Source: Unknown Source) - Collected 2026-08-03
...
### 4. [rosgluk (Rost Glukhov) · GitHub](../ai/agents/rosgluk-rost-glukhov-github.md) ([GitHub](https://github.com/rosgluk))
- Stars: 0
- Language: Unknown
...
- Stars: 0
- Language: Unknown
- Description: - **Agentic AI Coding Assistants**: Research focuses on reconstructing prompt patterns and agent coordination mechanisms for autonomous AI-driven coding assistants, emphasizing system prompts and p...
...
### 10. [NousResearch/hermes-agent](../ai/agents/nousresearch-hermes-agent.md) ([GitHub](https://github.com/nousresearch/hermes-agent))
- Stars: 0
- Language: Unknown
- Description: - **Multi-Provider LLM Integration**: Hermes-Agent supports Anthropic, OpenAI, and other LLM providers, enabling cross-platform agentic workflows with unified API access for Claude, ChatGPT, and Co...
...
- Stars: 0
- Language: Unknown
- Description: - **Curated Resource**: Aggregates GitHub Copilot enhancement files (instructions, prompts, MCPs, agent markdowns) for AI agent development and customization.
...
- Stars: 0
- Language: Unknown
- Description: - **Curated Repository**: Hosts community-driven resources (instructions, agents, skills, configurations) to optimize GitHub Copilot usage, with 37,392 stars and 4,700 forks.
