...
- [llm · PyPI](../ai/rag/llm-pypi.md) (Source: Unknown Source) - Collected 2026-08-02
...
- Stars: 0
- Language: Unknown
- Description: - **Curated Resource Hub**: GitHub repository aggregating community-driven tools, agents, skills, and configurations to optimize GitHub Copilot usage, including prompt engineering templates and cus...
...
- Stars: 0
- Language: Unknown
- Description: *   Catalogs GitHub Copilot enhancement assets including instructions, prompts, skills, MCPs, and agent markdown files.

### 13. [ali-bahrainian/RAG_best_practices](../ai/rag/ali-bahrainian-rag-best-practices.md) ([GitHub](https://github.com/ali-bahrainian/rag_best_practices))
- Stars: 0
- Language: Unknown
