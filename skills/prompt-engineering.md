...
- [AI Document Parsing Software: AI-Ready Data at Scale | LlamaIndex](../ai/rag/ai-document-parsing-software-ai-ready-data-at-scal.md) (Source: Unknown Source) - Collected 2026-08-03
...
- Stars: 0
- Language: Unknown
- Description: - **Multi-LLM Framework**: Supports integration with OpenAI, Anthropic, Gemini, and other LLMs via unified APIs, enabling cross-model agent orchestration.
...
- Stars: 0
- Language: Unknown
- Description: - **Trilingual learning roadmap** covering agentic AI, from LLM fundamentals to multi-agent systems, with **240+ curated resources** and practical examples in Python.
...
- Stars: 0
- Language: Unknown
- Description: - **Agentic AI Coding Assistants**: Research focuses on reconstructing prompt patterns and coordination mechanisms for autonomous AI agents in software development workflows.
...
- Stars: 0
- Language: Unknown
- Description: - **RAG Implementation Guide**: Repository provides best practices for integrating retrieval-augmented generation (RAG) with large language models (LLMs), focusing on optimizing retrieval quality a...
...
- Stars: 0
- Language: Unknown
- Description: - **Curated Resource**: A GitHub repository (`Code-and-Sorts/awesome-copilot-agents`) hosting a structured collection of GitHub Copilot enhancement files, including instructions, prompts, skills, M...

### 13. [github/awesome-copilot](../ai/agents/github-awesome-copilot.md) ([GitHub](https://github.com/github/awesome-copilot))
- Stars: 0
- Language: Unknown
- Description: - **Resource Hub**: Curated collection of community-driven instructions, agents, skills, and configurations to optimize GitHub Copilot usage, covering customization, prompt engineering, and AI-driv...
