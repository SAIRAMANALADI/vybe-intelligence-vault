...
Active signals: 285 resources matched in the intelligence vault.
Recently detected signals:
- [langchain-ai/data-enrichment](../ai/agents/langchain-ai-data-enrichment.md) (Source: Unknown Source) - Collected 2026-07-14
- [langchain-ai/langgraph](../ai/rag/langchain-ai-langgraph.md) (Source: Unknown Source) - Collected 2026-07-14
...
- [WenyuChiou/awesome-agentic-ai-zh](../ai/rag/wenyuchiou-awesome-agentic-ai-zh.md) (Source: Unknown Source) - Collected 2026-07-14
...
- Stars: 0
- Language: Unknown
- Description: - **Comprehensive 2026 AI Agent Learning Path**: Covers LangChain, LangGraph, Coze, Dify, MCP, LLM, RAG, and prompt engineering with a structured curriculum targeting enterprise-level AI agent deve...
...
- Stars: 0
- Language: Unknown
- Description: - **Local LLM Integration**: Demonstrates end-to-end RAG workflow using locally deployed language models (e.g., Ollama, LM Studio) with Langchain for inference.
...
### 10. [langchain-ai/data-enrichment](../ai/agents/langchain-ai-data-enrichment.md) ([GitHub](https://github.com/langchain-ai/data-enrichment))
- Stars: 0
- Language: Unknown
- Description: - **Purpose**: LangGraph Studio template for building agents that autonomously perform web research to generate or enhance structured datasets.
