...
Active signals: 513 resources matched in the intelligence vault.
...
- [Prompt engineering | OpenAI API](../ai/rag/prompt-engineering-openai-api.md) (Source: Unknown Source) - Collected 2026-08-05
...
- [langchain-ai/react-agent](../ai/agents/langchain-ai-react-agent.md) (Source: Unknown Source) - Collected 2026-08-05
...
### 4. [wgcyeo/UniversalRAG](../ai/rag/wgcyeo-universalrag.md) ([GitHub](https://github.com/wgcyeo/universalrag))
- Stars: 0
- Language: Unknown
...
### 10. [langchain-ai/react-agent](../ai/agents/langchain-ai-react-agent.md) ([GitHub](https://github.com/langchain-ai/react-agent))
- Stars: 0
- Language: Unknown
- Description: - **Template Overview**: Provides a LangGraph-based implementation of a ReAct (Reasoning and Acting) agent in Python, designed for modular and observable agent workflows.
...
- Stars: 0
- Language: Unknown
- Description: - **Curated Resource Hub**: Aggregates community-driven guides, agents, skills, and configurations to optimize GitHub Copilot usage across Python-based workflows.
