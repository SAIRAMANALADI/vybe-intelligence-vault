...
Original source URL: https://huggingface.co/blog/unified-tool-use

## Local Vault File

Path: [huggingface-blog-unified-tool-use.md](../../ai/models/huggingface-blog-unified-tool-use.md)
