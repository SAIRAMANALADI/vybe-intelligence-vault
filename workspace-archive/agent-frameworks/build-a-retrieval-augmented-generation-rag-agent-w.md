...
- **Pipeline Workflow**: Implements a Retrieval Chain with a retriever tool, where the ReAct agent selectively activates retrieval only when additional context is req
