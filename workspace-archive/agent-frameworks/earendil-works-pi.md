...
- **Coding Agent CLI**: Includes a command-line interface (CLI) for deploying and managing coding agents capable of autonomous code generation, debugging, and ex
