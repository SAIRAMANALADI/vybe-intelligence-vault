...
local_vault_path: ai/agents/openrouter.md
quality_score: 70
archive_score: 70
archive_tier: useful
...
- **Audit Trail Requirements**: For each posture, enforce **provable audit trails** via:
  - **Static**: Immutable logs of model invocations ti
...
Original source URL: https://openrouter.ai

## Local Vault File

Path: [openrouter.md](../../ai/agents/openrouter.md)
