...
- **LLM-to-Tool Orchestration**: Bridges **generative AI models** with real-world security workflows by translating natural language prompts into executable commands for tools like
