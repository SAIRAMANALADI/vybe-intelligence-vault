...
- **Technical Scope**: Supports multi-agent systems, LLM integration, MCP, Docker deployment, and no-code automation with Anthropic and Claude compatibility.
- **Community & Contribution**: Open-source project with 3,787 stars, 616 forks, and a submission system for new agent templates; last updated July 9, 2026.
