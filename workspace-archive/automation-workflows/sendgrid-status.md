...
source_url: https://status.sendgrid.com
resource_id: blog:sendgrid-status
local_vault_path: ai/rag/sendgrid-status.md
quality_score: 70
archive_score: 72
archive_tier: useful
...
Original source URL: https://status.sendgrid.com

## Local Vault File

Path: [sendgrid-status.md](../../ai/rag/sendgrid-status.md)
