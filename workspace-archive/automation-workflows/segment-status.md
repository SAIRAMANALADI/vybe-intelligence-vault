...
source_url: https://status.segment.com
resource_id: blog:segment-status
local_vault_path: ai/rag/segment-status.md
quality_score: 70
archive_score: 72
archive_tier: useful
...
Original source URL: https://status.segment.com

## Local Vault File

Path: [segment-status.md](../../ai/rag/segment-status.md)
