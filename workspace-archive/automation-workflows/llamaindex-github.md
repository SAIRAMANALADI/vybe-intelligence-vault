...
- **Open-Source Tooling**: Includes `LiteParse` (lightweight OCR), `LlamaAgents` (workflow orchestration), and `LlamaIndex` (Python framework) with respective docs linked in the repository.
