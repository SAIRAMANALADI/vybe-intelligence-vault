...
- **Installation** is supported across platforms via package managers (e.g., `brew install gh` for macOS, `winget` for Windows) or direct downloads (`.deb`, `.rpm`, `.msi`, `.tar.gz`, binaries).

- **Advanced features** include GitHub Copilot CLI integr
