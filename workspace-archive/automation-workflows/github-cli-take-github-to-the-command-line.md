...
- **Cross-platform installation** is supported via package managers (Homebrew, WinGet, apt, dnf, zypper) or direct binary downloads for macOS, Windows, and Linux.
- **Advanced features** include GitHub Copilot CLI integration, custom aliases (e.g., `gh a
