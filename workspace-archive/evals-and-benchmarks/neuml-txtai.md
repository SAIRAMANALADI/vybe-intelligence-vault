...
- **Core Components**: Supports embeddings (sentence-transformers), vector databases, transformers, and retrieval-augmented generation (RAG) for information retrieval and NLP tasks.
- **Technical Stack**: Built on Python with integrations for large language models (LLMs), sentence embeddings, and vector se
