...
- **Core RAG Workflow**: Three-stage process—**Retrieval** (embedding-based vector search for relevant data), **Augmentation** (combining retrieved context with the original query into a richer promp
