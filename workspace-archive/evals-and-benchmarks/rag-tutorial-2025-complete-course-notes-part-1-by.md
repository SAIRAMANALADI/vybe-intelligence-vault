...
- **Embeddings & Vector DBs**: Text chunks are converted into high-dimensional vector embeddings (e.g., OpenAI’s 3,072-dim vectors) using specialized models; these vectors are stored in vecto
