...
- Supports forward/backward pass kernels (`flash_fwd_kernel_sm90.h`, `flash_bwd_kernel_sm90.h`) with static/dynamic kernel selection via `heuristics.h` and `static_switch.h`.

- Includes FP8 precision support (`benchmark_flash_attention_fp8.py`) and paged KV cac
