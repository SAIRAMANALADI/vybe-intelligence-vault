...
- **LlamaIndex v0.12.0** introduces semantic chunking and +30% retrieval accuracy improvements, optimized for large-scale unstructured data with `DBConnectors` and multi-format support (PDFs, CSVs, Word).

- **RAGFlow v0.24.0** supports enterprise-grade, multi-modal RAG with agent
