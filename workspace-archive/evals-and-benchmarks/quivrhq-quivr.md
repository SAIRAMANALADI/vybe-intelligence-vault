...
- **Multi-Format & Multi-Store Support**: Enables integration with any file type and provides flexibility in deployment via Docker, with support for multiple databases (PostgreSQL) and vector stores, ensu
