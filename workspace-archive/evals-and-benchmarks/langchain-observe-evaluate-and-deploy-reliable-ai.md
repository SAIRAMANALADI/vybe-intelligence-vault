...
- **Core capabilities** include framework-agnostic tracing (via OpenTelemetry/SDKs), multi-turn message threading, LLM-as-judge evals, durable checkpointing for async agent workflows, and native support for A2A/MCP protocols.

- **Enterprise features** encompass human-in-the-loop interac
