...
- **Open-Source Tooling**: Includes `LiteParse` (lightweight OCR), `LlamaAgents` (agentic workflows), and the core `LlamaIndex` Python library for document indexing and retrieval, with respective docs linked.

- **Community & Support**: Maintains active presence on X (Twit
