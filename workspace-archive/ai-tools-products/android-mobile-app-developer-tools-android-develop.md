...
- **Android 17 & API 37 Release**: Android 17 source code is live on AOSP, rolling out to Pixel devices; key updates include new APIs and tools for developers to optimize apps for API 37.

- **Android XR Platform Expansion**: Introduces expanded engine suppor
