...
- **Android 17 & XR Platform**: Android 17 (API 37) is now live on AOSP with Pixel rollouts; Android XR platform updates include expanded engine support, new tools, and resources for immersive development.
