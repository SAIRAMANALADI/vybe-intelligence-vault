...
- **Redirect Handling**: Post-authentication redirects to `/playground/generate` for new users via `redirect_uri` parameter.
...
Path: [login-cohere.md](../../ai/resources/login-cohere.md)
