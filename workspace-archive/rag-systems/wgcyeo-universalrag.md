...
- **Unified Retrieval Mechanism**: Implements a modality-agnostic retrieval system using cross-modal embeddings (e.g., CLIP, BLIP, or custom encoders) and granularity-aware chunking strat
