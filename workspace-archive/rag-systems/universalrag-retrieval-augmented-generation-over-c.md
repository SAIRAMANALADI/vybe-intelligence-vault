...
- **Modality-Aware Routing**: Mitigates the *modality gap* problem (where retrieval favors same-modality items) by dynamically selecting the most relevant modality-specific co
