...
- **Technical Mechanism**: Leverages *trigger-based poisoning* where adversarial documents are crafted to exploit RAG’s retrieval and generation pipeline, ensuring target misinformation is ret
