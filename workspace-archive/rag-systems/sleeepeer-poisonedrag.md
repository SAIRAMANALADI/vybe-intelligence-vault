...
- **Technical Mechanism**: Exploits vulnerabilities in RAG pipelines via *semantic poisoning*—crafting adversarial documents that embed trigger phrases or misleading context, ensuring target resp
