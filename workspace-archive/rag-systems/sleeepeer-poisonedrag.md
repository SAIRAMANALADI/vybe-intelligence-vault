...
- **Technical Mechanism**: Leverages *trigger-based poisoning* where adversarial documents are crafted to contain subtle, context-aware perturbations (e.g., synonym substitutions, syntactic va
