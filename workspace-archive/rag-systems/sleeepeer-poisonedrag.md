...
- **Technical Mechanism**: Exploits vulnerabilities in the retrieval-augmentation pipeline by crafting adversarial documents that trigger specific token sequences in the LLM, byp
