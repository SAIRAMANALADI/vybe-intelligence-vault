...
- **Adaptive Report Generation**: The agent classifies query types (process/how-to, conceptual, technical deep-dive) and adapts output format accordingly, including archi
