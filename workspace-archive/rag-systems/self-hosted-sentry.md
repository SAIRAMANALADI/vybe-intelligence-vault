...
local_vault_path: ai/rag/self-hosted-sentry.md
quality_score: 70
archive_score: 72
archive_tier: useful
...
Original source URL: https://develop.sentry.dev/self-hosted/

## Local Vault File

Path: [self-hosted-sentry.md](../../ai/rag/self-hosted-sentry.md)
