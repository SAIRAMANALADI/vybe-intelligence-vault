...
- **Key Features**:
  ...
  - Supports evaluation metrics for information retrieval, semantic search, and LLM-based QA tasks.
  - Designed for Python-based RAG pipelines with modular evaluation to
