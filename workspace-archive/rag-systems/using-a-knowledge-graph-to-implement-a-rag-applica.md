...
- **Core RAG Process**: Retrieval (embedding-based vector search + structured filtering), Augmentation (combining retrieved data with user input into an augmented prompt), and Generation (LLM respons
