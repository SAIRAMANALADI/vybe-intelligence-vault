...
- **Advanced Techniques**: Implements hierarchical retrieval, query expansion (LLM-generated variants), hybrid search (dense + sparse vectors), re-ranking (cross-encoder models), and adaptive retrieval (Self-RAG) to
