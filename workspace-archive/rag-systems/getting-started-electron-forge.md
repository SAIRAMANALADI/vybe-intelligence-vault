...
- **Packaging constraints**: Requires `node_modules` on disk; incompatible with Yarn PnP and symlinked dependencies. Workarounds: Yarn ≥2 (`nodeLinker: node-modules`), pnpm (
