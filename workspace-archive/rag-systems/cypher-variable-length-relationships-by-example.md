...
- **Zero-length path utility**: Enables binding to the same node via `-[REL_TYPE*0..N]->` (e.g., `[:PREVIOUS_POST*0..1]`), simplifying queries by avoiding `OPTIONAL MATCH` for optional relationsh
