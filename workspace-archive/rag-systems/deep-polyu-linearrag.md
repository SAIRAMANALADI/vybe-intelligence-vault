...
- **Graph Construction & Traversal**: Implements a linear graph structure where nodes (text chunks) are connected via weighted edges derived from semantic similarity, allowing for linear-
