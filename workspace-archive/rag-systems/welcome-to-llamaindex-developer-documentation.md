...
- **Polymorphism**: Enables objects of different classes to be treated as objects of a common superclass, allowing method overriding and dynamic method resolution.
