...
- **Encapsulation**: Binds data and methods that operate on the data within a single unit (e.g., class), restricting direct access to some components for improved integrity and security.
