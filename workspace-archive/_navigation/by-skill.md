...
- [Copilot CLI sessions in Visual Studio Code](https://code.visualstudio.com/docs/copilot/agents/background-agents) (Tier: `useful` | [`Local File`](../../ai/agents/copilot-cli-sessions-in-visual-studio-code.md))
