...
- **[Guardrails and Security](../guardrails-security/README.md)** (5455 files): Prompt injection defenses, jailbreak detection, LLM firewalls, PII redaction, agent security, and MCP security warnings.
...
- **[Automation Workflows](../automation-workflows/README.md)** (1182 files): Local automation, n8n, browser automation, GitHub Actions examples, Python scripts, cron, and task scheduler workflows.
