...
- **[RAG Systems](../rag-systems/README.md)** (10697 files): RAG apps, retrieval pipelines, embeddings, chunking, reranking, graph RAG, and multimodal retrieval systems.
- **[Vector Databases](../vector-databases/README.md)** (4149 files): Vector databases, embedding stores, vector search libraries, and retrieval storage examples.
- **[Datasets](../datasets/README.md)** (7359 files): AI datasets, evaluation datasets, RAG datasets, benchmark datasets, and synthetic data tools.

## LLMOps, Evals & Model Infrastructure

- **[Evals and Benchmarks](../evals-and-benchmarks/README.md)** (10070 files): Evaluation tools and benchmarks for LLMs, RAG systems, agents, prompts, hallucinations, and SWE tasks.
...
- **[Model Providers](../model-providers/README.md)** (1807 files): Public metadata and documentation links for model APIs and provider ecosystems.
