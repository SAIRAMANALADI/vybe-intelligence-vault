...
- **[RAG Systems](../rag-systems/README.md)** (10898 files): RAG apps, retrieval pipelines, embeddings, chunking, reranking, graph RAG, and multimodal retrieval systems.
- **[Vector Databases](../vector-databases/README.md)** (4206 files): Vector databases, embedding stores, vector search libraries, and retrieval storage examples.
...
- **[Evals and Benchmarks](../evals-and-benchmarks/README.md)** (10274 files): Evaluation tools and benchmarks for LLMs, RAG systems, agents, prompts, hallucinations, and SWE tasks.
