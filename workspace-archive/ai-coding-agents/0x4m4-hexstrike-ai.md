...
- **Offensive Security Automation**: Bridges LLMs with real-world offensive security capabilities, allowing AI agents to perform **Kali Linux toolset operations**, CTF tasks, and pentesting wo
