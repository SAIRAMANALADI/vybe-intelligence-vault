...
local_vault_path: ai/agents/as-relationships-caida.md
quality_score: 70
archive_score: 70
archive_tier: useful
...
- **Valid Path Constraints**: AS paths must adhere to **valley-
...
Original source URL: http://www.caida.org/data/as-relationships/

## Local Vault File

Path: [as-relationships-caida.md](../../ai/agents/as-relationships-caida.md)
