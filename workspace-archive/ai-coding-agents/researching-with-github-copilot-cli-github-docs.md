...
local_vault_path: ai/agents/researching-with-github-copilot-cli-github-docs.md
quality_score: 70
archive_score: 75
archive_tier: useful
...
- **Adaptive Report Generation**: The agent classifies query types (process/how-to, conceptual, or technical deep-dive) and adapts output format accordingly, generating a
...
Path: [researching-with-github-copilot-cli-github-docs.md](../../ai/agents/researching-with-github-copilot-cli-github-docs.md)
