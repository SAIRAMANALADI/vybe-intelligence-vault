...
- **Python-Based Automation Framework**: Built in Python, the repository bridges LLMs with real-world security operations, supporting CTF tools, generative AI, and MCP (Model Context Protoc
