...
- **Core RAG Pipeline**: Three-stage process—**Retrieval** (embedding-based semantic search or structured filtering), **Augmentation** (combining retrieved data with user input into a richer prompt),
