...
- **Advanced Techniques**: Implements hierarchical retrieval, query expansion, hybrid search (vector + BM25), re-ranking (cross-encoder models), and self-RAG for adaptive, multi-step retrieval to reduce hallucination
