...
- **Technical Scope**: Focuses on **LLM (Large Language Model) skills**, **AI agent customization**, and CLI-based interactions, covering tools for **Anthropic**, **OpenAI**, **Gemini**, **Llama**, **Qwen**, and related ecosy
