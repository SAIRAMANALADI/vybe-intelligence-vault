...
local_vault_path: ai/rag/gemini-cli-authentication-setup-gemini-cli.md
quality_score: 70
archive_score: 72
archive_tier: useful
...
Original source URL: https://geminicli.com/docs/get-started/authentication#set-your-google-cloud-project

## Local Vault File

Path: [gemini-cli-authentication-setup-gemini-cli.md](../../ai/rag/gemini-cli-authentication-setup-gemini-cli.md)
