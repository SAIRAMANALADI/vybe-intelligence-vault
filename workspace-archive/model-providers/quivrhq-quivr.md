...
- **Multi-Platform Compatibility**: Supports any file type, integrates with Docker, and provides APIs for frontend (React/TypeScript) and backend (Python) with backend-agnostic LLM/vector store fl
