...
- **Multi-Format & Multi-Store Support**: Supports **any file type** (PDFs, text, etc.) and integrates with **any vector database** (PGVector, Faiss) or LLM backend, ensuring flexi
