...
- **Technical Implementation**: Leverages adversarial document crafting techniques (e.g., embedding perturbations, trigger-based poisoning) to exploit RAG’s retrieval-augmenta
