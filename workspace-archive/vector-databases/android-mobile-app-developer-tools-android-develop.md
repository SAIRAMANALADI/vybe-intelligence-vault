...
- **Android 17 & XR Platform**: Android 17 (API 37) is now live on AOSP with Pixel rollouts, while Android XR expands engine support and resources for immersive app development ([XR blog](http
