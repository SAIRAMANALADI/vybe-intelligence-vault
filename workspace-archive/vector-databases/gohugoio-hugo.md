...
- **Performance regression fix** in v0.164.0 addresses slow builds in large sites (introduced in v0.128.0).
- **Deprecation**: `resources.PostProcess` replaced by `templates.Defer` in v0.164.0.
