...
local_vault_path: ai/rag/using-custom-elements-web-apis-mdn.md
quality_score: 70
archive_score: 70
archive_tier: useful
...
- **Registration & Scoping**: Custom elements are registered via `customElements.define
...
Original source URL: https://developer.mozilla.org/docs/Web/Web_Components/Using_custom_elements

## Local Vault File

Path: [using-custom-elements-web-apis-mdn.md](../../ai/rag/using-custom-elements-web-apis-mdn.md)
