...
- **Syntax & Constraints**: Takes a relative selector list as an argument, inherits specificity from its most specific selector, cannot be nested, and rejects pseudo-elements or pseudo-elements as
