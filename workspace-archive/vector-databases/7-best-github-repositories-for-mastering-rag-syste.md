...
- **RAGFlow**: Open-source RAG framework optimized for document understanding, featuring advanced document parsing (OCR, layout analysis), multi-modal retrieval, and fine-tuned pipelines for enterprise-gra
