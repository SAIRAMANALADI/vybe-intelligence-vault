...
- **Advanced Retrieval Techniques**: Implements hybrid search (semantic + BM25), query expansion (LLM-generated variants), re-ranking (cross-encoder models), and hierarch
