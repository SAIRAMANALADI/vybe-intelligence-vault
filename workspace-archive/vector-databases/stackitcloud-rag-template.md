...
- **Dependencies**: Python-centric stack leveraging vector databases, FastAPI for REST endpoints, and RAG-specific libraries for document processing and retrie
