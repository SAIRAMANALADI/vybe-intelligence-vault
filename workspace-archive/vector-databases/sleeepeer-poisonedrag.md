...
- **Technical Implementation**: Leverages adversarial document embedding techniques (e.g., trigger-based or semantic poisoning) to manipulate retrieval rankings and embed hidden backdoors in RAG pipeli
