...
- **Technical Mechanism**: Details a two-phase attack—*document poisoning* (embedding adversarial content in retrieved documents) and *response manipulation* (exploiting RAG’s retrieval-generation pipeline to a
