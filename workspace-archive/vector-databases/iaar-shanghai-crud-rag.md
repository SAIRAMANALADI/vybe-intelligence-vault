...
- **Evaluation Framework**: The benchmark includes **multi-modal retrieval** (text, tables, knowledge graphs) and assesses LLMs on **contextual understanding**, **retrieval accuracy**, and **response generati
