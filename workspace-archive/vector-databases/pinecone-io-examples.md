...
- **File Structure**: Contains a Jupyter Notebook (`02b-semantic-chunking.ipynb`) under `/learn/generation/better-rag/` for semantic chunking in RAG pipelines.
- **File Details**: The notebook is 2 MB in size, with commit history accessible via GitHub's interface.
