...
- **Core RAG Components**: Consists of three stages—**Retrieval** (embedding-based vector search for relevant data), **Augmentation** (enriching user queries with retrieved context), and **Generation
