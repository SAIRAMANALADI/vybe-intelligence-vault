...
- **Core RAG Workflow**: Three-stage process—**Retrieval** (embedding-based semantic search), **Augmentation** (combining retrieved context with user query into an augmented prompt), and **Generation
