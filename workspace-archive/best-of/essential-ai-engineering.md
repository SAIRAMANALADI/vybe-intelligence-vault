...
- **Category**: `ai/trending` | **Kind**: `TUTORIAL` | **Tier**: `ESSENTIAL`
- **Score**: `87` | **Path**: [`anthropics-claude-plugins-official.md`](../../ai/trending/anthropics-claude-plugins-official.md)
- **Selection Reason**: Strong keyword match, Active open-source repository
