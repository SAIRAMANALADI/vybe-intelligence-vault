...
- **Score**: `85` | **Path**: [`ektogamat-r3f-webgpu-starter.md`](file:///../../web-development/react-three-fiber/ektogamat-r3f-webgpu-starter.md)
- **Selection Reason**: Strong keyword match, Active open-source repository

### [playcanvas/engine](https://github.com/playcanvas/engine)
- **Category**: `web-development/webgpu` | **Kind**: `TOOL` | **Tier**: `USEFUL`
- **Score**: `83` | **Path**: [`playcanvas-engine.md`](file:///../../web-development/webgpu/playcanvas-engine.md)
- **Selection Reason**: Strong keyword match, Active open-source repository
...
- **Score**: `83` | **Path**: [`patriciogonzalezvivo-lygia.md`](file:///../../web-development/webgpu/patriciogonzalezvivo-lygia.md)
...
- **Score**: `83` | **Path**: [`hjlld-learningwebgpu.md`](file:///../../web-development/webgpu/hjlld-learningwebgpu.md)
- **Selection Reason**: Strong keyword match, Active open-source repository
...
- **Score**: `83` | **Path**: [`mrdoob-three-js.md`](file:///../../web-development/threejs/mrdoob-three-js.md)
- **Selection Reason**: Strong keyword match, Useful for project building

### [luosijie/threejs-examples](https://github.com/luosijie/threejs-examples)
- **Category**: `web-development/threejs` | **Kind**: `TOOL` | **Tier**: `USEFUL`
- **Score**: `83` | **Path**: [`luosijie-threejs-examples.md`](file:///../../web-development/threejs/luosijie-threejs-examples.md)
- **Selection Reason**: Strong keyword match, Active open-source repository
