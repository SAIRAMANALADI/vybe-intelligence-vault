...
- **GitHub-Native MCP Integration**: Built on GitHub’s Model Context Protocol (`/mcp`), the CLI interacts natively with issues, PRs, and branches, inheriting organizational policies (branch protections, governance)
