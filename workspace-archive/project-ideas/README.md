...
Project ideas for AI apps, RAG systems, agents, automations, 3D web experiences, and full-stack AI products.

## Why It Matters

Hands-on projects are the only way to build real competency in agent orchestration and 3D web design.
...
- [crewAIInc/crewAI Release: 1.15.1a1](https://github.com/crewaiinc/crewai)
...
- General domain tutorials and articles

## Project Ideas

- Create a portfolio showcasing a local agent, a RAG doc search, and a 3D animation
