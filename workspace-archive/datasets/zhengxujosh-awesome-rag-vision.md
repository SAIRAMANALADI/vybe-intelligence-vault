...
- **Scope & Focus**: Encompasses cutting-edge RAG frameworks, datasets, and tools tailored for **vision-centric tasks** (e.g., image captioning, visual question answering, object detection) with
