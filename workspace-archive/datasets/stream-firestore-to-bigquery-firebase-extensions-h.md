...
- **Dual BigQuery Resources**: Creates a raw changelog table (full history) and a view (current state) per collection, with support for materialized views (incremental/non-incremental) and optional partitioning/clustering.
- **Cross-Project & CMEK Suppo
