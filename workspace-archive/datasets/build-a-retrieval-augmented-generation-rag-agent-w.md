...
- **Core Components**: Implements a Retrieval Chain with a retriever tool, enabling the ReAct Agent to query a vectorized knowledge base via semantic search, hybrid retrieval, an
