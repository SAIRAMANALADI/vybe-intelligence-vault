...
- **Core RAG Process**: Retrieval (embedding-based vector search), augmentation (combining retrieved data with user input into an augmented prompt), and generation (LLM response based on grounded con
