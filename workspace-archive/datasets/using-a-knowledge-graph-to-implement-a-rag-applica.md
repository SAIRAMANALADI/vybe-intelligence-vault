...
- **Core RAG Process**: Three-stage workflow—**Retrieval** (embedding-based vector search for relevant context), **Augmentation** (combining retrieved data with user input into a richer prompt), and
