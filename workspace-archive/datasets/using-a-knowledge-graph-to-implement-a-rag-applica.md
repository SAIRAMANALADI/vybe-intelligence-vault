...
- **Core RAG Process**: Three-stage workflow—**Retrieval** (embedding-based semantic search), **Augmentation** (combining retrieved data with user input into an augmented prompt), and **Generation**
