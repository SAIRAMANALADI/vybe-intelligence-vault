...
*   **Community Boards** — Tech forums (e.g., Hacker News, Reddit developer channels).
*   **Media Channels** — Educational videos and walk-throughs (e.g., public YouTube developer guides).
*   **Academic Work** — Open preprint archives (e.g., arXiv, Papers with Code).
*   **Engineering Blogs** — Public company devlogs, newsletters, and RSS feeds.
...
*   `title` — The original title of the project, paper, or article.
*   `source_url` — The direct hyperlink to the original source.
*   `local_vault_path` — The relative path to help coding agents reference this file.
